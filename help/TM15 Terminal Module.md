...
The TM15 Terminal Module is a terminal expansion module for snapping on to a standard mounting rail according to DIN 50022. The number of available digital inputs/outputs within a drive system can be expanded with the TM15. It provides 24 bidirectional digital inputs/outputs (isolated into three groups), see [TM15 interfaces](#tm15-interfaces).

TM15 Terminal Modules are connected via DRIVE-CLiQ, inserted via the device view and displayed appropriately in the topology.
...
2. If you want to assign digital outputs (0...7, 8…15, 16…23), proceed as follows:
   ...
   - Interconnect the signal sinks (r4022) for the digital outputs 0...7, 8…15, 16…23.
   - Interconnect the signal sinks (r4023) for the inverted digital outputs 0...7, 8…15, 16…23.
