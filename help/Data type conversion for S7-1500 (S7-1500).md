---
title: "Data type conversion for S7-1500: (S7-1500)"
package: ProgConvert15enUS
topics: 75
...
# Data type conversion for S7-1500: (S7-1500)

This section contains information on the following topics:

- [Overview of data type conversion (S7-1500)](#overview-of-data-type-conversion-s7-1500)
- [Implicit conversions (S7-1500)](#implicit-conversions-s7-1500)
- [Explicit conversions (S7-1500)](#explicit-conversions-s7-1500)

## Overview of data type conversion (S7-1500)
...
> **Converting REF()**
>
> A data type conversion of REF() is not possible. The transferred tag must correspond exactly to the target data type.
...
## Implicit conversions (S7-1500)

This section contains information on the following topics:

- [Activate or deactivate IEC check (S7-1500)](#activate-or-deactivate-iec-check-s7-1500)
- [Binary numbers (S7-1500)](#binary-numbers-s7-1500)
- [Integers (S7-1500)](#integers-s7-1500)
- [Floating-point numbers (S7-1500)](#floating-point-numbers-s7-1500)
- [Timers (S7-1500)](#timers-s7-1500)
- [Date and time-of-day (S7-1500)](#date-and-time-of-day-s7-1500)
- [String (S7-1500)](#string-s7-1500)

### Activate or deactivate IEC check (S7-1500)

The data types of the operands used are checked for compatibility. This compatibility test can be carried out according to criteria that are more or less strict. If "IEC check for code blocks" is activated, stricter criteria are applied.
...
### Binary numbers (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of BOOL (S7-1500)](#implicit-conversion-of-bool-s7-1500)
- [Bit strings (S7-1500)](#bit-strings-s7-1500)

#### Implicit conversion of BOOL (S7-1500)
...
[Explicit conversion of BOOL (S7-1500)](#explicit-conversion-of-bool-s7-1500)

#### Bit strings (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of BYTE (S7-1500)](#implicit-conversion-of-byte-s7-1500)
- [Implicit conversion of WORD (S7-1500)](#implicit-conversion-of-word-s7-1500)
- [Implicit conversion of DWORD (S7-1500)](#implicit-conversion-of-dword-s7-1500)
- [Implicit conversion of LWORD (S7-1500)](#implicit-conversion-of-lword-s7-1500)

##### Implicit conversion of BYTE (S7-1500)
...
[Explicit conversion of BYTE (S7-1500)](#explicit-conversion-of-byte-s7-1500)

##### Implicit conversion of WORD (S7-1500)
...
[Explicit conversion of WORD (S7-1500)](#explicit-conversion-of-word-s7-1500)

##### Implicit conversion of DWORD (S7-1500)
...
[Explicit conversion of DWORD (S7-1500)](#explicit-conversion-of-dword-s7-1500)

##### Implicit conversion of LWORD (S7-1500)
...
[LWORD (S7-1500)](Data%20types.md#lword-s7-1500)
  
[Explicit conversion of LWORD (S7-1500)](#explicit-conversion-of-lword-s7-1500)

### Integers (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of SINT (S7-1500)](#implicit-conversion-of-sint-s7-1500)
- [Implicit conversion of USINT (S7-1500)](#implicit-conversion-of-usint-s7-1500)
- [Implicit conversion of INT (S7-1500)](#implicit-conversion-of-int-s7-1500)
- [Implicit conversion of UINT (S7-1500)](#implicit-conversion-of-uint-s7-1500)
- [Implicit conversion of DINT (S7-1500)](#implicit-conversion-of-dint-s7-1500)
- [Implicit conversion of UDINT (S7-1500)](#implicit-conversion-of-udint-s7-1500)
- [Implicit conversion of LINT (S7-1500)](#implicit-conversion-of-lint-s7-1500)
- [Implicit conversion of ULINT (S7-1500)](#implicit-conversion-of-ulint-s7-1500)

#### Implicit conversion of SINT (S7-1500)
...
[SINT (8-bit integers) (S7-1200, S7-1500)](Data%20types.md#sint-8-bit-integers-s7-1200-s7-1500)
  
[Explicit conversion of SINT (S7-1500)](#explicit-conversion-of-sint-s7-1500)

#### Implicit conversion of USINT (S7-1500)
...
[USINT (8-bit integers) (S7-1200, S7-1500)](Data%20types.md#usint-8-bit-integers-s7-1200-s7-1500)
  
[Explicit conversion of USINT (S7-1500)](#explicit-conversion-of-usint-s7-1500)

#### Implicit conversion of INT (S7-1500)
...
[Explicit conversion of INT (S7-1500)](#explicit-conversion-of-int-s7-1500)

#### Implicit conversion of UINT (S7-1500)
...
[UINT (16-bit integers) (S7-1200, S7-1500)](Data%20types.md#uint-16-bit-integers-s7-1200-s7-1500)
  
[Explicit conversion of UINT (S7-1500)](#explicit-conversion-of-uint-s7-1500)

#### Implicit conversion of DINT (S7-1500)
...
[Explicit conversion of DINT (S7-1500)](#explicit-conversion-of-dint-s7-1500)

#### Implicit conversion of UDINT (S7-1500)
...
[UDINT (32-bit integers) (S7-1200, S7-1500)](Data%20types.md#udint-32-bit-integers-s7-1200-s7-1500)
  
[Explicit conversion of UDINT (S7-1500)](#explicit-conversion-of-udint-s7-1500)

#### Implicit conversion of LINT (S7-1500)
...
[LINT (64-bit integers) (S7-1500)](Data%20types.md#lint-64-bit-integers-s7-1500)
  
[Explicit conversion of LINT (S7-1500)](#explicit-conversion-of-lint-s7-1500)

#### Implicit conversion of ULINT (S7-1500)
...
[ULINT (64-bit integers) (S7-1500)](Data%20types.md#ulint-64-bit-integers-s7-1500)
  
[Explicit conversion of ULINT (S7-1500)](#explicit-conversion-of-ulint-s7-1500)

### Floating-point numbers (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of REAL (S7-1500)](#implicit-conversion-of-real-s7-1500)
- [Implicit conversion of LREAL (S7-1500)](#implicit-conversion-of-lreal-s7-1500)

#### Implicit conversion of REAL (S7-1500)
...
[Explicit conversion of REAL (S7-1500)](#explicit-conversion-of-real-s7-1500)

#### Implicit conversion of LREAL (S7-1500)
...
[Explicit conversion of LREAL (S7-1500)](#explicit-conversion-of-lreal-s7-1500)

### Timers (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of S5TIME (S7-1500)](#implicit-conversion-of-s5time-s7-1500)
- [Implicit conversion of TIME (S7-1500)](#implicit-conversion-of-time-s7-1500)
- [Implicit conversion of LTIME (S7-1500)](#implicit-conversion-of-ltime-s7-1500)

#### Implicit conversion of S5TIME (S7-1500)
...
[Explicit conversion of S5TIME (S7-1500)](#explicit-conversion-of-s5time-s7-1500)

#### Implicit conversion of TIME (S7-1500)
...
[Explicit conversion of TIME (S7-1500)](#explicit-conversion-of-time-s7-1500)

#### Implicit conversion of LTIME (S7-1500)
...
[LTIME (IEC time) (S7-1500)](Data%20types.md#ltime-iec-time-s7-1500)
  
[Explicit conversion of LTIME (S7-1500)](#explicit-conversion-of-ltime-s7-1500)

### Date and time-of-day (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of DT (S7-1500)](#implicit-conversion-of-dt-s7-1500)
- [Implicit conversion of LDT (S7-1500)](#implicit-conversion-of-ldt-s7-1500)
- [Implicit conversion of DTL (S7-1500)](#implicit-conversion-of-dtl-s7-1500)
- [Implicit conversion of DATE (S7-1500)](#implicit-conversion-of-date-s7-1500)
- [Implicit conversion of TOD (S7-1500)](#implicit-conversion-of-tod-s7-1500)
- [Implicit conversion of LTOD (S7-1500)](#implicit-conversion-of-ltod-s7-1500)

#### Implicit conversion of DT (S7-1500)
...
[Explicit conversion of DT (S7-1500)](#explicit-conversion-of-dt-s7-1500)

#### Implicit conversion of LDT (S7-1500)
...
[Explicit conversion of LDT (S7-1500)](#explicit-conversion-of-ldt-s7-1500)
  
[LDT (DATE_AND_LTIME) (S7-1500)](Data%20types.md#ldt-date_and_ltime-s7-1500)

#### Implicit conversion of DTL (S7-1500)
...
[Explicit conversion of DTL (S7-1500)](#explicit-conversion-of-dtl-s7-1500)

#### Implicit conversion of DATE (S7-1500)
...
[Explicit conversion of DATE (S7-1500)](#explicit-conversion-of-date-s7-1500)

#### Implicit conversion of TOD (S7-1500)
...
[Explicit conversion of TOD (S7-1500)](#explicit-conversion-of-tod-s7-1500)

#### Implicit conversion of LTOD (S7-1500)
...
[Explicit conversion of LTOD (S7-1500)](#explicit-conversion-of-ltod-s7-1500)
  
[LTOD (LTIME_OF_DAY) (S7-1500)](Data%20types.md#ltod-ltime_of_day-s7-1500)

### String (S7-1500)

This section contains information on the following topics:

- [Implicit conversion of CHAR (S7-1500)](#implicit-conversion-of-char-s7-1500)
- [Implicit conversion of WCHAR (S7-1500)](#implicit-conversion-of-wchar-s7-1500)
- [Implicit conversion of STRING (S7-1500)](#implicit-conversion-of-string-s7-1500)
- [Implicit conversion of WSTRING (S7-1500)](#implicit-conversion-of-wstring-s7-1500)

#### Implicit conversion of CHAR (S7-1500)
...
[Explicit conversion of CHAR (S7-1500)](#explicit-conversion-of-char-s7-1500)

#### Implicit conversion of WCHAR (S7-1500)
...
[WCHAR (S7-1200, S7-1500)](Data%20types.md#wchar-s7-1200-s7-1500)
  
[Explicit conversion of WCHAR (S7-1500)](#explicit-conversion-of-wchar-s7-1500)

#### Implicit conversion of STRING (S7-1500)
...
[Explicit conversion of STRING (S7-1500)](#explicit-conversion-of-string-s7-1500)

#### Implicit conversion of WSTRING (S7-1500)
...
[Explicit conversion of WSTRING (S7-1500)](#explicit-conversion-of-wstring-s7-1500)

## Explicit conversions (S7-1500)

This section contains information on the following topics:

- [Binary numbers (S7-1500)](#binary-numbers-s7-1500-1)
- [Integers (S7-1500)](#integers-s7-1500-1)
- [Floating-point numbers (S7-1500)](#floating-point-numbers-s7-1500-1)
- [Timers (S7-1500)](#timers-s7-1500-1)
- [Date and time-of-day (S7-1500)](#date-and-time-of-day-s7-1500-1)
- [String (S7-1500)](#string-s7-1500-1)
...
- [Explicit conversion of BOOL (S7-1500)](#explicit-conversion-of-bool-s7-1500)
- [Bit strings (S7-1500)](#bit-strings-s7-1500-1)

#### Explicit conversion of BOOL (S7-1500)
...
##### Explicit conversion of BYTE (S7-1500)
...
| WORD<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | BYTE_TO_WORD |  |
| DWORD<sup>1)</sup> | X | BYTE_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | BYTE_TO_LWORD |  |  |
| SINT | X | BYTE_TO_SINT |  |  |
...
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) are interpreted as an unsigned integer with the same bit length. The data type BYTE is interpreted as USINT, WORD as UINT, DWORD as UDINT and LWORD as ULINT. |  |  |  |  |
...
##### Explicit conversion of WORD (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | WORD_TO_BYTE |  |
| DWORD<sup>1)</sup> | X | WORD_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | WORD_TO_LWORD |  |  |
...
##### Explicit conversion of DWORD (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | DWORD_TO_BYTE |  |
| WORD<sup>1)</sup> | X | DWORD_TO_WORD |  |  |
| LWORD<sup>1)</sup> | X | DWORD_TO_LWORD |  |  |
...
##### Explicit conversion of LWORD (S7-1500)
...
| Source | Destination | Conversion | Explanation | Mnemonics of the instruction |
| --- | --- | --- | --- | --- |
| LWORD<sup>1)</sup> | BOOL | X | The following possibilities can occur:  - If the source is "0", the destination data type is also "0" and the enable output ENO "1". - If only the LSB (Least Significant Bit) "1" is set in the source value, the destination data type is also "1" and the enable output ENO "1". - If bit is not equal to LSB in the source value, the destination data type is set according to LSB and the enable output ENO is "0". | LWORD_TO_BOOL |
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | LWORD_TO_BYTE |  |
| WORD<sup>1)</sup> | X | LWORD_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | LWORD_TO_DWORD |  |  |
...
#### Explicit conversion of SINT (S7-1500)
...
| LWORD<sup>1)</sup> | X | SINT_TO_LWORD |  |  |
...
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data types CHAR and WCHAR are initially extended to the necessary width including sign, and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of USINT (S7-1500)
...
| LWORD <sup>1)</sup> | X | USINT_TO_LWORD |  |  |
...
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data types CHAR and WCHAR are initially extended to the necessary width (the non-existing sign is replaced with zeros), and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of INT (S7-1500)
...
| LWORD<sup>1)</sup> | X | INT_TO_LWORD |  |  |
...
#### Explicit conversion of UINT (S7-1500)
...
| LWORD <sup>1)</sup> | X | UINT_TO_LWORD |  |  |
| SINT | X | UINT_TO_SINT |  |  |
...
#### Explicit conversion of DINT (S7-1500)
...
| LWORD<sup>1)</sup> | X |  | DINT_TO_LWORD |  |  |
...
#### Explicit conversion of UDINT (S7-1500)
...
| BYTE <sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged, right-justified, to the target data type. If bits are lost in the process, the enable output ENO is set to "0". | UDINT_TO_BYTE |  |
| WORD<sup>1)</sup> | X | UDINT_TO_WORD |  |  |
| DWORD <sup>1)</sup> | X | UDINT_TO_DWORD |  |  |
| LWORD <sup>1)</sup> | X | UDINT_TO_LWORD |  |  |
...
#### Explicit conversion of LINT (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged, right-justified, to the target data type. If a negative value is converted to an unsigned target data type, the enable output ENO is set to "0". | LINT_TO_BYTE |  |
| WORD<sup>1)</sup> | X | LINT_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | LINT_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | LINT_TO_LWORD |  |  |
| SINT | X | LINT_TO_SINT |  |  |
...
| CHAR<sup>1)</sup> | X | The bit pattern of the source value is converted and transferred to the target data type. (The value "-1" (16#FF) becomes the value "-1" (16#FFFFFFFF)). If a negative value is converted to an unsigned target data type, the enable output ENO is set to "0". | LINT_TO_CHAR |  |
| WCHAR<sup>1)</sup> | X | LINT_TO_WCHAR |  |  |
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data types CHAR and WCHAR are initially extended to the necessary width including sign, and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of ULINT (S7-1500)
...
| BYTE <sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged, right-justified, to the target data type. | ULINT_TO_BYTE |  |
| WORD<sup>1)</sup> | X | ULINT_TO_WORD |  |  |
| DWORD <sup>1)</sup> | X | ULINT_TO_DWORD |  |  |
| LWORD <sup>1)</sup> | X | ULINT_TO_LWORD |  |  |
...
| CHAR <sup>1)</sup> | X | The bit pattern of the source value is converted and transferred to the target data type. | ULINT_TO_CHAR |  |
| WCHAR <sup>1)</sup> | X | ULINT_TO_WCHAR |  |  |
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data types CHAR and WCHAR are initially extended to the necessary width (the non-existing sign is replaced with zeros), and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of REAL (S7-1500)
...
#### Explicit conversion of LREAL (S7-1500)
...
#### Explicit conversion of S5TIME (S7-1500)
...
| BYTE | - | - |  |  |
| WORD<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | S5TIME_TO_WORD |  |
...
| CHAR | - | - |  |  |
| WCHAR | - | - |  |  |
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data types CHAR and WCHAR are initially extended to the necessary width, and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of TIME (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | TIME_TO_BYTE |  |
| WORD<sup>1)</sup> | X | TIME_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | TIME_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | TIME_TO_LWORD |  |  |
...
#### Explicit conversion of LTIME (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | LTIME_TO_BYTE |  |
| WORD<sup>1)</sup> | X | LTIME_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | LTIME_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | LTIME_TO_LWORD |  |  |
...
#### Explicit conversion of DT (S7-1500)
...
#### Explicit conversion of LDT (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | LDT_TO_BYTE |  |
| WORD<sup>1)</sup> | X | LDT_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | LDT_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | LDT_TO_LWORD |  |  |
| SINT | X | LDT_TO_SINT |  |  |
...
#### Explicit conversion of DTL (S7-1500)
...
#### Explicit conversion of DATE (S7-1500)
...
| LWORD<sup>1)</sup> | X | DATE_TO_LWORD |  |  |
...
#### Explicit conversion of TOD (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | TOD_TO_BYTE |  |
| WORD<sup>1)</sup> | X | TOD_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | TOD_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | TOD_TO_LWORD |  |  |
...
#### Explicit conversion of LTOD (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | LTOD_TO_BYTE |  |
| WORD<sup>1)</sup> | X | LTOD_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | LTOD_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | LTOD_TO_LWORD |  |  |
...
#### Explicit conversion of CHAR (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | CHAR_TO_BYTE |  |
| WORD<sup>1)</sup> | X | CHAR_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | CHAR_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | CHAR_TO_LWORD |  |  |
| SINT | X | CHAR_TO_SINT |  |  |
...
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data type WCHAR are initially extended to the necessary width, and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of WCHAR (S7-1500)
...
| BYTE<sup>1)</sup> | X | The bit pattern of the source value is transferred unchanged right-justified to the destination data type. | WCHAR_TO_BYTE |  |
| WORD<sup>1)</sup> | X | WCHAR_TO_WORD |  |  |
| DWORD<sup>1)</sup> | X | WCHAR_TO_DWORD |  |  |
| LWORD<sup>1)</sup> | X | WCHAR_TO_LWORD |  |  |
...
| x: Conversion possible  - : Conversion not possible   <sup>1)</sup> Bit strings (BYTE, WORD, DWORD, LWORD) and the data type CHAR are initially extended to the necessary width, and then the bits are copied. The source type determines the interpretation. |  |  |  |  |
...
#### Explicit conversion of STRING (S7-1500)
...
#### Explicit conversion of WSTRING (S7-1500)
