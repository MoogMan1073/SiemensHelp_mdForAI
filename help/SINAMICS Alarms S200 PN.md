---
title: "SINAMICS Alarms S200 PN"
package: sdral425enUS
topics: 426
source: Siemens TIA Portal Information System (offline help, en-US)
---


# SINAMICS Alarms S200 PN
...
## SINAMICS Alarms S200 PN 01000 - 01902
...
### F01661 SI: Simulation of the safety inputs active
...
The simulation of the digital inputs is active (p0795).  
...
For xxxx = 10002:  
- Set "SI F-DI switchover discrepancy time" (p10002) greater than the "SI monitoring
clock cycle".  
...
Note:  
This fault results in an SS1 (Safe Stop 1) and as a consequence STO (Safe Torque Off)
is initiated.
...
Note:  
This message can be acknowledged via F-DI (safe acknowledgment).  
Discrepancy errors of an F-DI can only be acknowledged if safe acknowledgment was
carried out after the cause of the error was resolved (extended message acknowledgment,
self acknowledgment). As long as safety acknowledgment was not carried out, the corresponding
F-DI stays in the safe state internally.  
...
## SINAMICS Alarms S200 PN 01904 - 07461
...
## SINAMICS Alarms S200 PN 07462 - 30024
...
## SINAMICS Alarms S200 PN 30025 - 31813
...
## SINAMICS Alarms S200 PN 31850 - 35950
