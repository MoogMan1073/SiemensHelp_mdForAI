---
title: "TIA Portal Version Control Interface"
package: ReadmeVersionControlInterfaceenUS
topics: 3
...
### Comparison in Version Control Interface (F-CPUs)

If there is an F-CPU present in the project, you must log in to the Safety Administration Editor to be able to compare an object of the project with the relevant file in the Workspace.

---

**See also**

[TIA Portal Version Control Interface basics](Using%20TIA%20Portal%20Version%20Control%20Interface.md#tia-portal-version-control-interface-basics)
