---
title: "TB30 Option Module"
package: stdrui100000enUS
topics: 16
...
1. Interconnect the "Analog output 0" ([p4071](SINAMICS%20Parameter%20TB30%20%28Terminal%20Board%29%20%28sdrpa100enUS%29.md#p407101-ci-tb30-analog-outputs-signal-source)) signal source for the analog outputs of the TB30.
2. If you want to invert the analog signal, interconnect the signal source in the "Inversion" ([p4082](SINAMICS%20Parameter%20TB30%20%28Terminal%20Board%29%20%28sdrpa100enUS%29.md#p408201-bi-tb30-analog-outputs-invert-signal-source)) field.
...
4. To compensate temporary fluctuations of the measured value at the analog input, enter a time constant in the "Smoothing" ([p4073](SINAMICS%20Parameter%20TB30%20%28Terminal%20Board%29%20%28sdrpa100enUS%29.md#p407301-tb30-analog-outputs-smoothing-time-constant)) field.
...
5. To define a scaling characteristic via the scaling, click the "Scaling" button.
   ...
   The dialog closes.
6. Correct in the "Offset" ([p4083](SINAMICS%20Parameter%20TB30%20%28Terminal%20Board%29%20%28sdrpa100enUS%29.md#p408301-tb30-analog-outputs-offset)) field the specified voltage value of the offset.
