...
2. In the current group, activate the required temperature sensors ([p4111](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#p411102-tm150-group-channel-assignment)[0].0 to p4111[0].11 for the 12 temperature channels).
3. If required, interconnect the following signal sinks:

   - Minimum value ([p4113](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#r411302-co-tm150-group-temperature-actual-value-minimum-value)): Temperature minimum value of each group for the TM
   - Average value ([p4114](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#r411402-co-tm150-group-temperature-average-actual-value)): Temperature average value of each group for the TM
   - Maximum value ([p4112](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#r411202-co-tm150-group-temperature-actual-value-maximum-value)): Temperature maximum value of each group for the TM
...
- [r4105](SINAMICS%20Parameter%20SERVO.md#r4105-co-spindle-supplementary-temperature-actual-value)
- p4111
- [r4113](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#r411302-co-tm150-group-temperature-actual-value-minimum-value)
...
10. If required, interconnect the signal sink for the temperature signal ([p4105](SINAMICS%20Parameter%20SERVO.md#r4105-co-spindle-supplementary-temperature-actual-value)) for the TM120.
...
1. Select the 1x2- or 2x2-conductor evaluation measuring procedure for the relevant terminal block ([p4108](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#p410805-tm150-terminal-block-measuring-method)[0...5] = 0, 1).
2. Set the required sensor type for the relevant channel ([p4100](SINAMICS%20Parameter%20SERVO.md#p4100-spindle-supplementary-temperature-sensor-type)[x] = 1 ... 6, x = 0...5 or 0...11).
3. Bridge (short-circuit) the sensor to be connected.
4. Connect the sensor cables to the relevant terminals 1(+), 2(-) or 3(+), 4(-).
5. Start measurement of the cable resistance ([p4109](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#p4109011-tm150-wire-resistance-measurement)[x] = 1) for the relevant channel.
6. After p4109[x] = 0, check the measured resistance value in [p4110](SINAMICS%20Parameter%20TM150%20%28Terminal%20Module%29%20%28sdrpa208enUS%29.md#p4110011-tm150-wire-resistance-value)[x].
