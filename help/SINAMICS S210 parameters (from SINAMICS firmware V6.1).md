---
title: "SINAMICS S210 parameters (from SINAMICS firmware V6.1)"
package: StdrInfSysOptParaSinaS210fromRTv61enUS
topics: 2
source: Siemens TIA Portal Information System (offline help, en-US)
---


# SINAMICS S210 parameters (from SINAMICS firmware V6.1)

This section contains information on the following topics:

- [Explanation of the parameter information](#explanation-of-the-parameter-information)
- [SINAMICS S210 parameters (from SINAMICS firmware V6.1)](SINAMICS%20Parameter%20S210.md#sinamics-parameter-s210)
...
![Example](images/163251298699_DV_resource.Stream@PNG-en-US.png)
...
| - p0489[0...2] | Adjustable parameter 489 indices 0 to 2 |
...
Detailed information about user administration and access control and especially about function rights can be found on the following help page: [Access control](User%20administration%20and%20security.md#access-control)
