...
- [G120D-2 overview](#g120d-2-overview)
- [G120D-2 function diagram overview](#g120d-2-function-diagram-overview)
- [Encoder assignment](#encoder-assignment)

### G120D-2 overview

#### Overview

The distributed SINAMICS G120D-2 frequency converter belongs to the SINAMICS G series. It has the same advantages, such as a modular system and innovative safety engineering (Safety Integrated) and combines these with a special design and high degree of protection. It incorporates positioning functionality and is characterized by extended safety functions, as well as fail-safe inputs and outputs.

SINAMICS G120D-2 is available in the following versions:
...
### G120D-2 function diagram overview
...
PROFIdrive - STW1 control word interconnection (basic positioner) - 2475 -
...
PROFIdrive - ZSW1 status word interconnection (basic positioner) - 2479 -
...
Position sensing, encoder 1 ... 2 - 4704 -
...
![SSI encoder on the load side for the position controller, HTL encoder on the motor axis for the speed controller](images/103172629771_DV_resource.Stream@PNG-en-US.png)

SSI encoder on the load side for the position controller, HTL encoder on the motor axis for the speed controller
...
![HTL encoder on the motor axis for position and speed controllers](images/103172621067_DV_resource.Stream@PNG-en-US.png)

HTL encoder on the motor axis for position and speed controllers

| Symbol | Meaning |
| --- | --- |
| Advantage: | Favorably-priced solution. |
| Disadvantage: | Depending on the gear ratio, restrictions regarding the accuracy of the position control. |

**Position controller operates with SSI encoder, speed controller without an encoder**

![SSI encoder on the load side for the position controller, speed controller without an encoder](images/103172625419_DV_resource.Stream@PNG-en-US.png)

SSI encoder on the load side for the position controller, speed controller without an encoder

| Symbol | Meaning |
| --- | --- |
| Advantage: | Favorably-priced solution. |
| Disadvantages: | - Restrictions regarding the accuracy and dynamic performance of the position control - Travel to fixed stop is not possible. |
...
- [G120D-2 units](#g120d-2-units)
- [G120D-2 reference variables](#g120d-2-reference-variables)
- [G120D-2 I/O configuration](#g120d-2-io-configuration)
...
- [G120D-2 drive data sets DDS](#g120d-2-drive-data-sets-dds)

#### G120D-2 drive data sets DDS
...
- [G120D-2 command data sets CDS](#g120d-2-command-data-sets-cds)

#### G120D-2 command data sets CDS
...
You can select the unit system that the system is to use here. If you want to use the unit system depending on reference variables, you must define these reference variables at [Reference variables](#g120d-2-reference-variables).
...
- [G120D-2 terminal and interface overview](#g120d-2-terminal-and-interface-overview)
- [G120D-2 digital inputs](#g120d-2-digital-inputs)
- [G120D-2 digital outputs](#g120d-2-digital-outputs)
- [Analog inputs G120D-2 (only CU240D-2)](#analog-inputs-g120d-2-only-cu240d-2)
- [G120D-2 measuring inputs](#g120d-2-measuring-inputs)

### G120D-2 terminal and interface overview

#### Overview of the terminals and interfaces

Please refer to the following figure and table for the position and descriptions of the various interface connections on the control units - CU240D-2 including the PM250D power module.
...
The following figure shows the terminals and interfaces of the G120D-2 converter

![G120D-2 user interfaces](images/103172898571_DV_resource.Stream@PNG-en-US.png)

G120D-2 user interfaces

Description of the interfaces

| No. | Description | No. | Description |
| --- | --- | --- | --- |
| ① | Optical PC connection | ⑨ | HTL encoder connection |
| ② | Status LEDs | ⑩ | Digital inputs 0 and 1 |
| ③ | Input, 24 VDC supply | ⑪ | Digital inputs 2 and 3 |
| ④ | Output, 24 VDC supply | ⑫ | Digital inputs 4 and 5 |
| ⑤ | USB connection, address DIP switches (PROFIBUS) and bus termination switch | ⑬ | Analog inputs 0 and 1 |
| ⑥ | PROFIBUS IN or PROFINET P1 | ⑭ | PE terminal |
| ⑦ | PROFIBUS OUT or PROFINET P2 | ⑮ | Power supply connection |
| ⑧ | Digital outputs 0 and 1 | ⑯ | Connections for motor, brake and temperature sensor |

### G120D-2 digital inputs

#### Description

The digital inputs are pre-assigned with certain functions at the factory. You can adapt these interconnections or make additional interconnections. Depending on the version of the control unit, up to eight digital inputs are available.

The digital inputs can be used in pairs as fail-safe digital inputs (F-DI):

- X07; DI 0 and DI 1 result in F-DI 0
- X08; DI 2 and DI 3 result in F-DI 1
- X09; DI 4 and DI 5 result in F-DI 2

The interconnection is only displayed via graphic symbols after the parameterization of the safety functions.
...
### G120D-2 digital outputs

#### Description

You define the parameters of the digital outputs of the G120D-2 drive here.
...
| --- | --- | --- |
| **PIN** | **Function** |  |
| 1 | N/C | ![Digital outputs 0...1,](images/103172963467_DV_resource.Stream@PNG-en-US.png) |
...
### Analog inputs G120D-2 (only CU240D-2)

#### Description

The converter CU240D-2 has two analog inputs. You use them, for example, to specify speed setpoints manually.

The following setting options apply for the analog inputs:

- Analog input 0: Voltage or no sensor
- Analog input 1: Voltage or no sensor

BICO technology can be used to set further interconnection of the analog input, e.g. as a speed setpoint or setpoint for the technology controller.

#### Current I/O configuration

The text field displays the current I/O configuration (setting of p15). The analog inputs are pre-assigned accordingly.

#### Analog input as voltage input ([p0756](SINAMICS%20Parameter%20G120.md#p075603-cu-analog-inputs-type-2))

In order to determine whether the analog input is to be used as a voltage input, select one of the following settings:
...
- [8] No sensor connected
  ...
  No sensor is connected at this analog input.
...
- [G120D-2 setpoint sources and setpoint preparation](#g120d-2-setpoint-sources-and-setpoint-preparation)
- [G120D-2 motorized potentiometer](#g120d-2-motorized-potentiometer)
- [G120D-2 motorized potentiometer ramp-function generator](#g120d-2-motorized-potentiometer-ramp-function-generator)
- [G120D-2 fixed setpoints and fixed setpoint interconnection](#g120d-2-fixed-setpoints-and-fixed-setpoint-interconnection)
- [G120D-2 speed setpoint](#g120d-2-speed-setpoint)
- [G120D-2 speed limitation](#g120d-2-speed-limitation)
- [Ramp-function generator](#ramp-function-generator)

### G120D-2 setpoint sources and setpoint preparation
...
### G120D-2 motorized potentiometer
...
### G120D-2 motorized potentiometer ramp-function generator
...
### G120D-2 fixed setpoints and fixed setpoint interconnection
...
See also [Inhibit direction of rotation](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#inhibit-direction-of-rotation), [Invert setpoint](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#invert-setpoint) and [Running the motor in jog mode (JOG function)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#running-the-motor-in-jog-mode-jog-function).
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173144971_DV_resource.Stream@PNG-en-US.png) | [G120D-2 speed limitation](#g120d-2-speed-limitation) |
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103173184395_DV_resource.Stream@PNG-en-US.png) | [G120D-2 speed setpoint](#g120d-2-speed-setpoint) |
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173187723_DV_resource.Stream@PNG-en-US.png) | [G120D-2 ramp-function generator](#g120d-2-ramp-function-generator) |
...
- [G120D-2 ramp-function generator](#g120d-2-ramp-function-generator)
- [G120D-2 simple ramp-function generator](#g120d-2-simple-ramp-function-generator)
- [G120D-2 extended ramp-function generator](#g120d-2-extended-ramp-function-generator)

#### G120D-2 ramp-function generator
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103173144971_DV_resource.Stream@PNG-en-US.png) | [G120D-2 speed limitation](#g120d-2-speed-limitation) |

Select one of the following ramp-function generator types in the drop-down list:

- [G120D-2 simple ramp-function generator](#g120d-2-simple-ramp-function-generator)

  The simple ramp-function generator passes on the input values to the output via linear ramps, i.e. there is no rounding at the start and end of the range, the speed setpoint is accelerated or decelerated linearly.
- [G120D-2 extended ramp-function generator](#g120d-2-extended-ramp-function-generator)
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173239307_DV_resource.Stream@PNG-en-US.png) | [G120D-2 open-loop/closed-loop control type](#g120d-2-open-loopclosed-loop-control-type) |
...
#### G120D-2 simple ramp-function generator
...
#### G120D-2 extended ramp-function generator
...
- [G120D-2 setpoint addition](#g120d-2-setpoint-addition)
- [G120D-2 interpolator](#g120d-2-interpolator)
- [G120D-2 maximum limit](#g120d-2-maximum-limit)

#### G120D-2 setpoint addition

##### Description

The supplementary setpoint is used to incorporate correction values from higher-level controllers. This is easily carried out using an addition point for the main/supplementary setpoint in the setpoint channel. Both variables are imported simultaneously via two separate or one setpoint source and added in the setpoint channel.

The interpolator can be connected for both variables.

##### Signal source

| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103122989451_DV_resource.Stream@PNG-en-US.png) | [G120D-2 ramp-function generator](#g120d-2-ramp-function-generator) |

##### Parameters for the setpoint addition

1. In the "Droop input source" ([p1488](SINAMICS%20Parameter%20G120.md#p14880n-droop-input-source)) drop-down list, select from where the value is to be taken for the droop feedback.

   - 0: Droop feedback not connected
   - 1: Droop of the torque setpoint
   - 2: Droop of the speed controller output
   - 3: Droop of the speed controller integral output
2. "Speed setpoint 1" ([p1155](SINAMICS%20Parameter%20G120.md#p11550n-ci-speed-controller-speed-setpoint-1)); signal source for speed setpoint 1 of the speed controller.
3. "Speed setpoint 2" ([p1160](SINAMICS%20Parameter%20G120.md#p11600n-ci-speed-controller-speed-setpoint-2)); signal source for speed setpoint 1 of the speed controller.
...
- [Interpolator](#g120d-2-interpolator)
- [Speed setpoint limited](#g120d-2-maximum-limit)
- [Droop feedback](#g120d-2-droop-feedback)

##### Signal processing

| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103123041803_DV_resource.Stream@PNG-en-US.png) | [G120D-2 open-loop/closed-loop control type](#g120d-2-open-loopclosed-loop-control-type) |
...
- [G120D-2 open-loop/closed-loop control type](#g120d-2-open-loopclosed-loop-control-type)
- [Closed-loop speed control](#closed-loop-speed-control)
- [V/f control](#vf-control)
- [Torque control](#torque-control)

#### G120D-2 open-loop/closed-loop control type
...
| Symbol | Meaning |
| --- | --- |
| ![Setting the open-loop/closed-loop control types](images/103173406091_DV_resource.Stream@PNG-en-US.png) | Control with V/f characteristic ([G120D-2 V/f control](#g120d-2-vf-control)) |
| ![Setting the open-loop/closed-loop control types](images/103173239307_DV_resource.Stream@PNG-en-US.png) | Field-oriented control (vector control - [G120D-2 speed controller](#g120d-2-speed-controller)) |
...
- [G120D-2 speed controller](#g120d-2-speed-controller)
- [SINAMICS G120D-2 precontrol](#sinamics-g120d-2-precontrol)
- [G120D-2 droop feedback](#g120d-2-droop-feedback)

##### G120D-2 speed controller

###### Parameterizing the speed controller

The G120D-2 uses sensorless vector control (SLVC); it contains the following components:
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103173187723_DV_resource.Stream@PNG-en-US.png) | [G120D-2 ramp-function generator](#g120d-2-ramp-function-generator) |
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173445259_DV_resource.Stream@PNG-en-US.png) | [G120D-2 torque setpoint](#g120d-2-torque-setpoint) |
...
| Symbol | Meaning |
| --- | --- |
| Droop of the torque setpoint | [G120D-2 torque setpoint](#g120d-2-torque-setpoint) |
| Droop of the speed controller output | [G120D-2 speed controller](#g120d-2-speed-controller) |
...
- [G120D-2 V/f control](#g120d-2-vf-control)
- [G120D-2 V/f control characteristics](#g120d-2-vf-control-characteristics)
- [G120D-2 V/f characteristic settings](#g120d-2-vf-characteristic-settings)
- [G120D-2 V/f control I_max controller](#g120d-2-vf-control-i_max-controller)
- [G120D-2 slip compensation](#g120d-2-slip-compensation)
...
| Symbol | Meaning |
| --- | --- |
| ![Signal sources](images/103173187723_DV_resource.Stream@PNG-en-US.png) | [G120D-2 ramp-function generator](#g120d-2-ramp-function-generator) |
...
2. To steadily increase the voltage during the magnetization time, select the entry "Yes" in the "Soft starting voltage" ([p1350](SINAMICS%20Parameter%20G120.md#p13500n-uf-control-soft-start)) drop-down list.
3. Enter a "Reference frequency" ([p2000](SINAMICS%20Parameter%20G120.md#p2000-reference-speed-reference-frequency)) for frequency values.

###### Signal processing

| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173554315_DV_resource.Stream@PNG-en-US.png) | [G120D-2 current controller / power unit](#g120d-2-current-controller-power-unit) |
...
##### G120D-2 V/f control characteristics
...
##### G120D-2 V/f characteristic settings
...
##### G120D-2 V/f control I_max controller
...
- [G120D-2 torque control](#g120d-2-torque-control)

##### G120D-2 torque control
...
- [G120D-2 torque setpoint](#g120d-2-torque-setpoint)
- [G120D-2 torque limiting](#g120d-2-torque-limiting)

#### G120D-2 torque setpoint
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103173239307_DV_resource.Stream@PNG-en-US.png) | [G120D-2 speed controller](#g120d-2-speed-controller) |
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173720331_DV_resource.Stream@PNG-en-US.png) | [G120D-2 torque limiting](#g120d-2-torque-limiting-1) |
...
[G120D-2 torque limiting](#g120d-2-torque-limiting-1)

#### G120D-2 torque limiting
...
- [G120D-2 torque limiting](#g120d-2-torque-limiting-1)
- [G120D-2 upper torque limit](#g120d-2-upper-torque-limit)
- [G120D-2 current limitation](#g120d-2-current-limitation)
- [G120D-2 power limit](#g120d-2-power-limit)
- [G120D-2 lower torque limit](#g120d-2-lower-torque-limit)
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103173445259_DV_resource.Stream@PNG-en-US.png) | [G120D-2 speed controller](#g120d-2-speed-controller) |
...
| --- | --- |
|  | **Danger** |
| **Setting of the upper torque limit**  Negative values when setting the upper torque limit can result in motor "runaway". |  |
...
| --- | --- |
|  | **Danger** |
| **Setting of the lower torque limit**  Positive values when setting the lower torque limit can result in motor "runaway". |  |
...
- [G120D-2 current controller / power unit](#g120d-2-current-controller-power-unit)
- [G120D-2 power unit / operating values](#g120d-2-power-unit-operating-values)

#### G120D-2 current controller / power unit
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103173720331_DV_resource.Stream@PNG-en-US.png) | [G120D-2 torque limiting](#g120d-2-torque-limiting-1) |

##### Signal processing

| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103173934347_DV_resource.Stream@PNG-en-US.png) | [G120D-2 motor](#g120d-2-motor) |
...
#### G120D-2 power unit / operating values
...
- [G120D-2 shutdown functions](#g120d-2-shutdown-functions)
- [Brake control](#brake-control)
- [Safety Integrated](#safety-integrated)
- [G120D-2 automatic restart](#g120d-2-automatic-restart)
- [G120D-2 flying restart](#g120d-2-flying-restart)
- [Messages and monitors](#messages-and-monitors)

### G120D-2 shutdown functions
...
- [G120D-2 brake control](#g120d-2-brake-control)
- [G120D-2 motor holding brake](#g120d-2-motor-holding-brake)
- [G120D-2 DC brake](#g120d-2-dc-brake)

#### G120D-2 brake control

##### Selection of the brake type

The following brakes are available for the G120D-2 converter:
...
The extended functions provide additional safety functions such as SS1, SLS, SSM and SDI. See also [G120 control type / safety functions for extended functions](#g120-control-type-safety-functions-for-extended-functions).
...
- [G120 safe torque off (STO)](#g120-safe-torque-off-sto-1).
- [Test stop](#test-stop)
...
You can assign the parameters for the "Safe Torque Off (STO)" function here. See also [In Startdrive, how are the safe terminals assigned to a safety function?](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#in-startdrive-how-are-the-safe-terminals-assigned-to-a-safety-function).
...
###### G120D-2 inputs and outputs

For further information, see also [G120D-2 digital inputs](#g120d-2-digital-inputs) and [G120D-2 digital outputs](#g120d-2-digital-outputs).
...
- [G120D-2 load torque monitoring](#g120d-2-load-torque-monitoring)
- [G120D-2 motor temperature](#g120d-2-motor-temperature)

#### G120D-2 load torque monitoring
...
- [Basic positioning (CU250D-2 only)](#basic-positioning-cu250d-2-only)
- [Position controller (CU250D-2 only)](#position-controller-cu250d-2-only)
- [Technology controller (CU240D-2 only)](#technology-controller-cu240d-2-only)
- [Free function blocks (CU240D-2 only)](#free-function-blocks-cu240d-2-only)

### Basic positioning (CU250D-2 only)
...
### Position controller (CU250D-2 only)
...
### Technology controller (CU240D-2 only)

This section contains information on the following topics:

- [G120D-2 technology controller motorized potentiometer](#g120d-2-technology-controller-motorized-potentiometer)
- [G120D-2 MOP ramp-function generator of the technology controller](#g120d-2-mop-ramp-function-generator-of-the-technology-controller)
- [G120D-2 technology controller fixed setpoints](#g120d-2-technology-controller-fixed-setpoints)
- [G120D-2 technology controller PID control](#g120d-2-technology-controller-pid-control)
- [G120D-2 technology controller PID controller](#g120d-2-technology-controller-pid-controller)
- [G120D-2 technology controller ramp-up/ramp-down time](#g120d-2-technology-controller-ramp-upramp-down-time)
- [G120D-2 technology controller output limits](#g120d-2-technology-controller-output-limits)

#### G120D-2 technology controller motorized potentiometer
...
#### G120D-2 MOP ramp-function generator of the technology controller
...
#### G120D-2 technology controller fixed setpoints
...
#### G120D-2 technology controller PID control
...
#### G120D-2 technology controller PID controller
...
#### G120D-2 technology controller ramp-up/ramp-down time
...
#### G120D-2 technology controller output limits
...
### Free function blocks (CU240D-2 only)
...
For general information about the free function blocks, see [Memory functions](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#memory-functions).
...
- [G120D-2 PROFIdrive receive direction](#g120d-2-profidrive-receive-direction)
- [G120D-2 PROFIdrive send direction](#g120d-2-profidrive-send-direction)
- [G120D-2 PZD send/receive direction diagnostics](#g120d-2-pzd-sendreceive-direction-diagnostics)

### G120D-2 PROFIdrive receive direction
...
3. Click the ![Telegram selection](images/103176045323_DV_resource.Stream@PNG-en-US.png) button to display the control word / receive word bit-by-bit. For the free telegram configuration, the signals can be interconnected bit-by-bit here.
...
### G120D-2 PROFIdrive send direction
...
### G120D-2 PZD send/receive direction diagnostics
...
- [G120D-2 interconnections](#g120d-2-interconnections)

### G120D-2 interconnections
