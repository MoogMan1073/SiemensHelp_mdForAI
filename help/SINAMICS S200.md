...
- [Using measuring function (from SINAMICS firmware V6.2)](#using-measuring-function-from-sinamics-firmware-v62)
...
### From SINAMICS firmware V6.2

The following table lists the maximum quantity structure for SINAMICS S200 drives with SINAMICS firmware from V6.2, which can be recorded using the trace and logic analyzer function:

| Device | Maximum number of installed traces | Maximum number of signals per trace |
| --- | --- | --- |
| **SINAMICS S200** | 2 | 8 1...8 signals; 0.0625 ms minimum recording cycle |
...
The first trace configuration that you create for a SINAMICS S200 drive is preassigned with a preselection of signals to be recorded. Subsequently created trace configurations do not contain a preselection of signals to be recorded.
...
| - | ![Setting options and displays in "Signals"](images/167488741771_DV_resource.Stream@PNG-de-DE.png) | Button to open the signal selection table  The button is displayed when the table line is selected.  Clicking the icon opens a table which offers possible signals for selection. The selected signal is displayed in the input field. |
...
![Setting options and displays in "Recording conditions"](images/167488773259_DV_resource.Stream@PNG-en-US.png)
...
|  |  | ![Setting options and displays in "Recording conditions"](images/167488764939_DV_resource.Stream@PNG-de-DE.png) | Opens the signal selection table.  Clicking the icon opens a table which offers possible signals for selection as trigger tag. The selected signal is displayed in the input field. |
...
!["Bit pattern"](images/167488800395_DV_resource.Stream@PNG-en-US.png)
...
| Icon | Description |
| --- | --- |
| !["Bit pattern"](images/167488814987_DV_resource.Stream@PNG-de-DE.png) | Bit is not evaluated |
| !["Bit pattern"](images/167488823307_DV_resource.Stream@PNG-de-DE.png) | Bit is checked for FALSE |
| !["Bit pattern"](images/167488831627_DV_resource.Stream@PNG-de-DE.png) | Bit is checked for TRUE |
...
3. Select a signal. The following options are available:
   ...
   - In the "Name" column, click the ![Procedure](images/167488741771_DV_resource.Stream@PNG-de-DE.png) button and select a parameter.
...
4. Transfer the trace configuration to the device with the !["Start recording immediately" trigger condition](images/167488876427_DV_resource.Stream@PNG-de-DE.png) button.
...
2. Select a trigger parameter. The following options are available:
   ...
   - Click the !["Trigger on tag" trigger condition](images/167488741771_DV_resource.Stream@PNG-de-DE.png) button for the trigger parameter and select a parameter.
...
7. Transfer the trace configuration to the device with the !["Trigger on tag" trigger condition](images/167488876427_DV_resource.Stream@PNG-de-DE.png) button.
...
3. Transfer the trace configuration to the device with the !["Trigger on fault” trigger condition](images/167488876427_DV_resource.Stream@PNG-de-DE.png) button.
...
1. Select the "Trigger on alarm" entry in the drop-down list for "Trigger mode".
   ...
   The input fields for the trigger parameters are hidden.
2. Enter the pre-trigger, recording duration and cycle (see above).
3. Transfer the trace configuration to the device with the !["Trigger on alarm" trigger condition](images/167488876427_DV_resource.Stream@PNG-de-DE.png) button.

## Using measuring function (from SINAMICS firmware V6.2)
...
- The SINAMICS drive has a firmware version from FW V6.2.
...
![Structure of the measuring function](images/167489003019_DV_resource.Stream@PNG-en-US.png)
...
| Icon | Description |
| --- | --- |
| ![Icons on the toolbar](images/167488915979_DV_resource.Stream@PNG-de-DE.png) | Transfers the selected measuring function to the device. |
| ![Icons on the toolbar](images/167488924683_DV_resource.Stream@PNG-de-DE.png) | Transfers the selected measuring function from the device to the current project. |
| ![Icons on the toolbar](images/167488933387_DV_resource.Stream@PNG-de-DE.png) | Toggles the display between online and offline. |
| ![Icons on the toolbar](images/167488942091_DV_resource.Stream@PNG-de-DE.png) | Activates the measuring function on the selected drive.   During a recording, previously recorded values are lost. |
| ![Icons on the toolbar](images/167488950795_DV_resource.Stream@PNG-de-DE.png) | Deactivates the measuring function in the drive. |
| ![Icons on the toolbar](images/167488959499_DV_resource.Stream@PNG-de-DE.png) | Deletes the parameterization in the device. |
| ![Icons on the toolbar](images/167488968203_DV_resource.Stream@PNG-de-DE.png) | Repeats the measuring function automatically. |
| ![Icons on the toolbar](images/167488976907_DV_resource.Stream@PNG-de-DE.png) | Saves the selected measuring function to the "Measurements" folder. |
| ![Icons on the toolbar](images/167488985611_DV_resource.Stream@PNG-de-DE.png) | Exports the configuration of the measuring function to a file. |
| ![Icons on the toolbar](images/167488994315_DV_resource.Stream@PNG-de-DE.png) | Exports the measurement with the settings of the current view. |
...
The formula editor provides various mathematical functions for analyzing signals. You can open the editor in the signal table by clicking the ![Figure](images/167489519115_DV_resource.Stream@PNG-de-DE.png) button.

##### Configuration options and displays in the formula editor

![Formula dialog box](images/167489537419_DV_resource.Stream@PNG-en-US.png)
...
- The SINAMICS S200 drive has a firmware-Version from RT V6.2.
- The "Startdrive Advanced" license is available.
...
| Step | Description |
| --- | --- |
| 1 | [Create or call measuring function](#create-or-call-measuring-function) |
...
The following describes how you create a measuring function under the system folder ![Figure](images/167489578891_DV_resource.Stream@PNG-de-DE.png) "Trace" and how you display a measuring function that has been saved.

##### Requirements

- The configured drive supports the trace function.
- The SINAMICS S200 drive has a firmware version from SINAMICS FW V6.2.
- The operating unit is connected to the drive unit via LAN (physically ONLINE).
...
1. In the project tree, double-click on the corresponding icon (![Displaying saved settings of a selected measuring function](images/167489587595_DV_resource.Stream@PNG-de-DE.png) offline / ![Displaying saved settings of a selected measuring function](images/167489596299_DV_resource.Stream@PNG-de-DE.png) online) of a created measuring function.
...
| **Signals** |  |  |
|  | ![Possible settings](images/167489510795_DV_resource.Stream@PNG-de-DE.png) | Static display of the signal icon |
...
2. Select a signal. The following options are available:
   ...
   - In the "Name" column, click on the ![Configuring signals](images/167489615883_DV_resource.Stream@PNG-de-DE.png) icon and select a parameter.
...
- The project includes at least one measuring function in the "Traces" system folder ![Requirements](images/167489639051_DV_resource.Stream@PNG-de-DE.png).
...
3. Click the ![Transferring the measuring function to the drive](images/167488915979_DV_resource.Stream@PNG-de-DE.png) icon to transfer the measuring function to the drive unit.
...
1. To start the measuring function, click either the ![Starting/stopping the measuring function](images/167489665163_DV_resource.Stream@PNG-de-DE.png) icon on the “Master control” screen or, alternatively, the ![Starting/stopping the measuring function](images/167488942091_DV_resource.Stream@PNG-de-DE.png) icon in the toolbar.

   The selected measuring function is started. It measures the dynamic response of the selected drive.
2. To stop the measuring function, click either the ![Starting/stopping the measuring function](images/167489656459_DV_resource.Stream@PNG-de-DE.png) icon on the “Master control” screen or, alternatively, the ![Starting/stopping the measuring function](images/167488950795_DV_resource.Stream@PNG-de-DE.png) icon in the toolbar.
...
1. To superimose measuring functions, click on the ![Superimposing measuring functions](images/167488976907_DV_resource.Stream@PNG-de-DE.png) icon (Add to measuring functions) before starting the measuring function.
2. To start the measuring function, click either the ![Superimposing measuring functions](images/167489665163_DV_resource.Stream@PNG-de-DE.png) icon on the "Master control" screen form in the "Control" area or, alternatively, the ![Superimposing measuring functions](images/167488942091_DV_resource.Stream@PNG-de-DE.png) icon in the toolbar.

   The selected measuring function is started. It measures the dynamic response of the selected drive.
3. To stop the measuring function, click either the ![Superimposing measuring functions](images/167489656459_DV_resource.Stream@PNG-de-DE.png) icon on the "Master control" screen form in the "Control" area or, alternatively, the ![Superimposing measuring functions](images/167488950795_DV_resource.Stream@PNG-de-DE.png) icon in the toolbar.

   The selected measuring function is stopped.
4. Drag &amp; drop the measurements to the system folder ![Superimposing measuring functions](images/167489647755_DV_resource.Stream@PNG-de-DE.png) (overlaid measurements).
...
- The project includes at least one measuring function in the "Traces" system folder ![Requirement](images/167489639051_DV_resource.Stream@PNG-de-DE.png).
- The created measuring function is parameterized.
...
3. Click on the icon ![Loading the measuring function from the drive into the project](images/167488924683_DV_resource.Stream@PNG-de-DE.png)"Add trace configuration from device to trace configuration" to transfer the measuring function from the drive into the project.

The measuring function is transferred to the ![Loading the measuring function from the drive into the project](images/167489578891_DV_resource.Stream@PNG-de-DE.png) "Traces" system folder.
...
3. To delete the parameterization in the drive, click on the icon ![Deleting the parameterization in the drive](images/167488959499_DV_resource.Stream@PNG-de-DE.png)"Delete trace from the device".
...
2. Click on the icon ![Exporting the measuring function](images/167489687051_DV_resource.Stream@PNG-de-DE.png)"Export trace configuration" to export the selected measuring function.

   - OR -

   Select the ![Exporting the measuring function](images/167489639051_DV_resource.Stream@PNG-de-DE.png)"Traces" system folder and select "Export measurement" from the shortcut menu.
...
1. Mark the ![Importing the measuring function](images/167489639051_DV_resource.Stream@PNG-de-DE.png)"Traces" system folder and select "Import measuring function" from the shortcut menu.
