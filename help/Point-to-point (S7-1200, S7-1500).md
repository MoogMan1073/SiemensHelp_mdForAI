---
title: "Point-to-point (S7-1200, S7-1500)"
package: ProgFBCMPtPenUS
topics: 17
...
# Point-to-point (S7-1200, S7-1500)

This section contains information on the following topics:

- [Overview of Freeport communication (S7-1200, S7-1500)](#overview-of-freeport-communication-s7-1200-s7-1500)
- [Using the instructions (S7-1200, S7-1500)](#using-the-instructions-s7-1200-s7-1500)
- [General parameters for Freeport operations (S7-1200, S7-1500)](#general-parameters-for-freeport-operations-s7-1200-s7-1500)
- [Port_Config: Configure PtP communication port (S7-1200, S7-1500)](#port_config-configure-ptp-communication-port-s7-1200-s7-1500)
- [Send_Config: Configure PtP sender (S7-1200, S7-1500)](#send_config-configure-ptp-sender-s7-1200-s7-1500)
- [Receive_Config: Configure PtP recipient (S7-1200, S7-1500)](#receive_config-configure-ptp-recipient-s7-1200-s7-1500)
- [P3964_Config: Configuring the 3964(R) protocol (S7-1200, S7-1500)](#p3964_config-configuring-the-3964r-protocol-s7-1200-s7-1500)
- [Send_P2P: Sending data (S7-1200, S7-1500)](#send_p2p-sending-data-s7-1200-s7-1500)
- [Using the BUFFER and LENGTH parameters for communication operations (S7-1200, S7-1500)](#using-the-buffer-and-length-parameters-for-communication-operations-s7-1200-s7-1500)
- [Receive_P2P: Receiving data (S7-1200, S7-1500)](#receive_p2p-receiving-data-s7-1200-s7-1500)
- [Receive_Reset: Clear receive buffer (S7-1200, S7-1500)](#receive_reset-clear-receive-buffer-s7-1200-s7-1500)
- [Signal_Get: Read status (S7-1200, S7-1500)](#signal_get-read-status-s7-1200-s7-1500)
- [Signal_Set: Set accompanying signals (S7-1200, S7-1500)](#signal_set-set-accompanying-signals-s7-1200-s7-1500)
- [Get_Features: Get extended functions (S7-1200, S7-1500)](#get_features-get-extended-functions-s7-1200-s7-1500)
- [Set_Features: Set extended functions (S7-1200, S7-1500)](#set_features-set-extended-functions-s7-1200-s7-1500)
- [Error messages (S7-1200, S7-1500)](#error-messages-s7-1200-s7-1500)

## Overview of Freeport communication (S7-1200, S7-1500)
...
- Cyclic data exchange ([Performance optimized for many short frames](Configuration%20for%20point-to-point%20links%20%28S7-1500%29.md#special-features-for-the-use-of-the-option-for-performance-optimization-s7-1500))
...
- [Port_Config](#port_config-configure-ptp-communication-port-s7-1200-s7-1500)
- [Send_Config](#send_config-configure-ptp-sender-s7-1200-s7-1500)
- [Receive_Config](#receive_config-configure-ptp-recipient-s7-1200-s7-1500)
- [P3964_Config](#p3964_config-configuring-the-3964r-protocol-s7-1200-s7-1500)
...
- [Send_P2P](#send_p2p-sending-data-s7-1200-s7-1500)
- [Receive_P2P](#receive_p2p-receiving-data-s7-1200-s7-1500)
...
- [Receive_Reset](#receive_reset-clear-receive-buffer-s7-1200-s7-1500)
- [Signal_Get](#signal_get-read-status-s7-1200-s7-1500)
- [Signal_Set](#signal_set-set-accompanying-signals-s7-1200-s7-1500)

The following instructions let you read or write extended functions, as long as these are supported by the module.

- [Get_Features](#get_features-get-extended-functions-s7-1200-s7-1500)
- [Set_Features](#set_features-set-extended-functions-s7-1200-s7-1500)
...
## Using the instructions (S7-1200, S7-1500)
...
## General parameters for Freeport operations (S7-1200, S7-1500)
...
[Special features for the use of the option for performance optimization (S7-1500)](Configuration%20for%20point-to-point%20links%20%28S7-1500%29.md#special-features-for-the-use-of-the-option-for-performance-optimization-s7-1500)

## Port_Config: Configure PtP communication port (S7-1200, S7-1500)
...
| STATUS | OUT | Word |  | 16#7000 | Error code (see [Error messages](#error-messages-s7-1200-s7-1500)) |
| <sup>1)</sup> Required setting for the use of PROFIBUS cables with CM 1241 for RS485 |  |  |  |  |  |

Additional information about the general parameters is available at "[General parameters for Freeport operations](#general-parameters-for-freeport-operations-s7-1200-s7-1500)".

## Send_Config: Configure PtP sender (S7-1200, S7-1500)
...
## Receive_Config: Configure PtP recipient (S7-1200, S7-1500)
...
More information about the general parameters is available at "[General parameters for Freeport operations](#general-parameters-for-freeport-operations-s7-1200-s7-1500)".
...
## P3964_Config: Configuring the 3964(R) protocol (S7-1200, S7-1500)
...
## Send_P2P: Sending data (S7-1200, S7-1500)
...
| UNIVERSAL <sup>1)</sup> | OUT | Bool | --- | FALSE | Type of data communication between the CPU and the CM specified via PORT:  FALSE: [Performance optimization (cyclic)](Configuration%20for%20point-to-point%20links%20%28S7-1500%29.md#special-features-for-the-use-of-the-option-for-performance-optimization-s7-1500)  - Receive frames max. 24 bytes - Send frames max. 30 bytes   TRUE: Universal (acyclic)  - Limiting the frame length depending on the CM to 1, 2, or 4 KB |
| DONE | OUT | Bool |  | FALSE | TRUE for one cycle after the last request has been completed without errors |
| ERROR | OUT | Bool |  | FALSE | TRUE for one cycle after the last request has been completed with errors |
| STATUS | OUT | Word |  | 16#7000 | Error code (see [Error messages](#error-messages-s7-1200-s7-1500)) |
| <sup>1)</sup> Available from library version V4.0 |  |  |  |  |  |
...
## Using the BUFFER and LENGTH parameters for communication operations (S7-1200, S7-1500)
...
## Receive_P2P: Receiving data (S7-1200, S7-1500)
...
| STATUS | OUT | Word |  | 16#7000 | Error code (see [Error messages](#error-messages-s7-1200-s7-1500)) |
| LENGTH | OUT | UInt | Word | 0 | Length of the frame received in bytes   More information under "[Using the BUFFER and LENGTH parameters for communication operations](#using-the-buffer-and-length-parameters-for-communication-operations-s7-1200-s7-1500)". |
...
## Receive_Reset: Clear receive buffer (S7-1200, S7-1500)
...
## Signal_Get: Read status (S7-1200, S7-1500)
...
## Signal_Set: Set accompanying signals (S7-1200, S7-1500)
...
## Get_Features: Get extended functions (S7-1200, S7-1500)
...
## Set_Features: Set extended functions (S7-1200, S7-1500)
...
## Error messages (S7-1200, S7-1500)
...
| 16#8085 | Invalid length | Select a suitable frame length.  - UNIVERSAL = 1 (data communication via data sets): Depending on the module, permissible are: 1 to 1024/2048/4096 bytes - UNIVERSAL = 0 (data communication via IO data; [Performance optimized for many short frames](Configuration%20for%20point-to-point%20links%20%28S7-1500%29.md#special-features-for-the-use-of-the-option-for-performance-optimization-s7-1500)): Maximum length is 30 bytes (Send_P2P instruction). |
| 16#8087 | The number of characters received by the CM PtP module exceeds the number supported for UNIVERSAL = 0 (performance optimization). | Select a suitable frame length or use UNIVERSAL = 1 (data communication via data sets).  With UNIVERSAL = 0 ([performance optimization](Configuration%20for%20point-to-point%20links%20%28S7-1500%29.md#special-features-for-the-use-of-the-option-for-performance-optimization-s7-1500)), the maximum length is 24 bytes (Receive_P2P instruction). |
...
| 16#81C1 | Invalid end condition or no end condition selected | Select a suitable end condition (see [Sending data with Freeport](Configuration%20for%20point-to-point%20links%20%28S7-1500%29.md#sending-data-with-freeport-s7-1500)). |
