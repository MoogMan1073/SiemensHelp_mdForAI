...
- [G120 CU240-2 overview](#g120-cu240-2-overview)
- [G120 CU240-2 function diagram overview](#g120-cu240-2-function-diagram-overview)

### G120 CU240-2 overview

#### Overview

SINAMICS G120 is a modern drive system made up of various functional units. The main units are:
...
### G120 CU240-2 function diagram overview
...
Connection overview G120 CU240B-2 - 2201 -
  

Connection overview G120 CU240E-2 - 2202 -
  

CU240B-2: Isolated digital inputs (DI 0 … DI 3) - 2220 -
  

CU240E-2: Isolated digital inputs (DI 0 … DI 5) - 2221 -
  

CU240B-2: Digital output (DO 0) - 2240 -
  

CU240E-2: Digital outputs (DO 0 … DO 2) - 2242 -
  

CU240B-2: Analog input 0 (AI 0) - 2250 -
  

CU240E-2: Analog inputs 0 ... 1 (AI 0 ... AI 1) - 2251 -
  

CU240B-2: Analog inputs as digital input (DI 11) - 2255 -
  

CU240E-2: Analog inputs as digital inputs (DI 11 … DI 12) - 2256 -
  

CU240B-2: Analog output 0 (AO 0) - 2260 -
  

CU240E-2: Analog outputs 0 … 1 (AO 0 … AO 1) - 2261 -
...
STO (Safe Torque Off) (Part 1) - 2810 -
...
Vdc_max controller and Vdc_min controller (PM230/PM240) - 6220 -
...
U/f control, Vdc_max controller and Vdc_min controller (U/f) (PM230/PM240) - 6320 -
...
Field weakening characteristic, flux setpoint (ASM, p0300 = 1xx, p0096 = 2) - 6837 -
  

Field weakening controller, flux controller, Id setpoint (ASM, p0300 = 1xx, p0096 = 2) - 6838 -
  

Field weakening controller (PMSM, p0300 = 2xx, p0096 = 2) - 6839 -
  

Interface to the Power Module (ASM, p0300 = 1xx, p0096 = 2) - 6841 -
...
- [SINAMICS G120 CU240-2 Units](#sinamics-g120-cu240-2-units)
- [G120 CU240-2 reference variables](#g120-cu240-2-reference-variables)
- [G120 CU240-2 I/O configuration](#g120-cu240-2-io-configuration)
...
- [G120 CU240-2 drive data sets DDS](#g120-cu240-2-drive-data-sets-dds)

#### G120 CU240-2 drive data sets DDS
...
- [G120 CU240-2 command data sets CDS](#g120-cu240-2-command-data-sets-cds)

#### G120 CU240-2 command data sets CDS
...
### SINAMICS G120 CU240-2 Units

#### Description

You can select the unit system that the system is to use here. If you want to use the unit system depending on reference variables, you must define these reference variables at [Reference variables](#g120-cu240-2-reference-variables).
...
### G120 CU240-2 reference variables
...
Enter the following general variables:
...
Enter the following variable of the technology controller:

- Technology unit ([p0596](SINAMICS%20Parameter%20G120.md#p0596-technological-unit-reference-quantity))
...
### G120 CU240-2 I/O configuration
...
- [G120 CU240-2 terminal and interface overview](#g120-cu240-2-terminal-and-interface-overview)
- [G120 CU240-2 digital inputs](#g120-cu240-2-digital-inputs)
- [G120 CU240-2 relay outputs](#g120-cu240-2-relay-outputs)
- [G120 CU240-2 analog inputs](#g120-cu240-2-analog-inputs)
- [G120 CU240-2 analog outputs](#g120-cu240-2-analog-outputs)
- [G120 CU240-2 measuring input](#g120-cu240-2-measuring-input)

### G120 CU240-2 terminal and interface overview

#### Overview of the terminals and interfaces

The G120 CU240x-2 has the following inputs/outputs:
...
The following figure shows the terminals and interfaces using the G120 CU240E-2 converter as an example:

![User interfaces](images/103122634507_DV_resource.Stream@PNG-en-US.png)

User interfaces

|  |  |  |
| --- | --- | --- |
| ① | Slot for memory card (MMC or SD card) |  |
| ② | Interface for operator panel (IOP or BOP-2) |  |
| ③ | USB interface for Startdrive |  |
| ④ | Status LED |  |
|  | ![Overview of the interfaces](images/103122637963_DV_resource.Stream@PNG-en-US.png) | RDY |
| ![Overview of the interfaces](images/103122641291_DV_resource.Stream@PNG-en-US.png) | BF |  |
| ![Overview of the interfaces](images/103122644619_DV_resource.Stream@PNG-en-US.png) | SAFE |  |
| ⑤ | DIP switch for fieldbus address |  |
| ⑥ | DIP switch for AI0 and AI1 (terminals 3/4 and 10/11) |  |
| ⑦ | Terminal strip |  |
| ⑧ | Terminal designation |  |
| ⑨ | On-off switch, depending on fieldbus:  - USS, Modbus: Bus terminator - PROFIBUS, PROFINET: No function |  |
...
| --- | --- | --- |
| Terminal |  | Properties |
| 31 | +24V IN | 18 V ... 30 V optional electronics power supply |
| 32 | GND IN | Reference potential for terminal 31 |
| 34 | - | - |
| 10 | - | - |
| 11 | - | - |
| 26 | - | - |
| 27 | - | - |
|  |  |  |
| 1 | +10V OUT | 10 V output relative to GND, max. 10 mA |
| 2 | GND | Common reference potential |
| 3 | AI 0+ | Analog input 0 (-10 V ... 10 V, 0/4 mA ... 20 mA, -20 mA ... 20 mA) |
| 4 | AI 0- | Reference potential for analog input 0 |
| 12 | AO 0- | Analog output 0 (0 V … 10 V, 0 mA … 20 mA) |
| 13 | GND | Common reference potential |
|  | - | - |
|  | - | - |
| 14 | T1 MOTOR | Motor temperature sensor (PTC, KTY84-130 or bimetal NC contact) |
| 15 | T2 MOTOR | Motor temperature sensor (PTC, KTY84-130 or bimetal NC contact) |
| 9 | +24V OUT | 24 V output, reference potential GND, max. 200 mA |
| 28 | GND | Common reference potential |
| 69 | DI COM | Reference potential for digital inputs |
| 5 | DI 0 | Digital input 0 |
...
|  | - | - |
|  |  |  |
| 19 | DO 0 NO | Digital output 0, NO contact, 0.5 A, 30 VDC |
| 20 | DO 0 COM | Digital output 0, change-over contact |
...
| 31 | +24V IN | 18 V ... 30 V optional electronics power supply |
| 32 | GND IN | Reference potential for terminal 31 |
| 34 | DI COM2 | Reference potential for terminals 6, 8 and 17 |
| 10 | AI 1+ | Analog input (-10 V ... 10 V, 0/4/-20 mA ... 20 mA) |
| 11 | AI 1- | Reference potential for terminal 10 |
| 26 | AO 1+ | Analog output (0 V … 10 V, 0 mA … 20 mA) |
| 27 | GND | Common reference potential |
|  |  |  |
| 1 | +10V OUT | 10 V output relative to GND, max. 10 mA |
| 2 | GND | Common reference potential |
| 3 | AI 0+ | Analog input 0 (-10 V ... 10 V, 0/4 mA ... 20 mA, -20 mA ... 20 mA) |
...
| 12 | AO 0- | Analog output 0 (0 V … 10 V, 0 mA … 20 mA) |
| 13 | GND | Common reference potential |
| 21 | DO 1+ | Digital output, max. 0.5 A 30 |
| 22 | DO 1- | Digital output, max. 0.5 A 30 |
| 14 | T1 MOTOR | Motor temperature sensor (PTC, KTY84-130 or bimetal NC contact) |
| 15 | T2 MOTOR | Motor temperature sensor (PTC, KTY84-130 or bimetal NC contact) |
| 9 | +24V OUT | 24 V output, reference potential GND, max. 200 mA |
| 28 | GND | Common reference potential |
...
| 7 | DI 2 | Digital input 2 |
| 8 | DI 3 | Digital input 3 |
| 16 | DI 4 | Digital input 4 |
| 17 | DI 5 | Digital input 5 |
|  |  |  |
| 19 | DO 0 NO | Digital output 0, NO contact, 0.5 A, 30 VDC |
| 20 | DO 0 COM | Digital output 0, change-over contact |
| 18 | DO 0 NC | Digital output 0, NC contact |
...
### G120 CU240-2 analog inputs

#### Description

Depending on the control unit version, the converter has one or two analog inputs. You use it, for example, to specify speed setpoints manually.
...
[SINAMICS G120 interface assignments - CU240B-2](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#sinamics-g120-interface-assignments---cu240b-2)

### G120 CU240-2 analog outputs

#### Description

The control unit has one or two analog outputs (AO) depending on the version. You can use the analog outputs to display a wide range of signals, e.g. the current speed, the current output voltage or the current output current.

> **Note**
>
> G120 CU240B-2 only has one analog output.
...
### G120 CU240-2 measuring input

#### Monitoring the speed via digital input and measuring input

This function is only available for the CU240E‑2, CU240E‑2 DP, CU240E‑2 F and CU240E‑2 DP‑F control units. The monitoring sensor is connected to digital input 3.
...
- [G120 CU240-2 motorized potentiometer](#g120-cu240-2-motorized-potentiometer)
- [G120 CU240-2 motorized potentiometer ramp-function generator](#g120-cu240-2-motorized-potentiometer-ramp-function-generator)
- [G120 CU240-2 fixed setpoints and fixed setpoint interconnection](#g120-cu240-2-fixed-setpoints-and-fixed-setpoint-interconnection)
- [G120 CU240-2 speed setpoint](#g120-cu240-2-speed-setpoint)
- [G120 CU240-2 speed limitation](#g120-cu240-2-speed-limitation)
...
### G120 CU240-2 motorized potentiometer
...
- With manual control, specify the setpoint via a digital input.
- In automatic mode, a higher-level controller specifies the setpoint. You then interconnect the signal source via BICO.
...
1. To specify limit values for the speed setpoint in manual mode, enter a maximum ([p1037](SINAMICS%20Parameter%20G120.md#p10370n-motorized-potentiometer-maximum-speed)) and minimum value ([p1038](SINAMICS%20Parameter%20G120.md#p10380n-motorized-potentiometer-minimum-speed)).
...
1. "Automatic setpoint" ([p1041](SINAMICS%20Parameter%20G120.md#p10410n-bi-motorized-potentiometer-manualautomatic)) signal source for the setpoint in automatic mode.
   ...
   The motorized potentiometer is effective in manual mode, the speed setpoint is specified via the "Automatic setpoint" in automatic mode, e.g. from a higher-level controller.
...
### G120 CU240-2 motorized potentiometer ramp-function generator
...
### G120 CU240-2 fixed setpoints and fixed setpoint interconnection

#### Using fixed setpoints

Assign free speed setpoints as fixed setpoints. The values entered here are transferred directly to the motor. To activate the corresponding fixed speeds, interconnect the signals to digital inputs, or use the wiring macros via p15. See also [Fixed speed as setpoint source](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#fixed-speed-as-setpoint-source).
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103122946699_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 speed limitation](#g120-cu240-2-speed-limitation) |
...
### G120 CU240-2 speed limitation

#### Parameterizing the speed limitation

Limit the speed setpoint by a minimum and maximum speed. Set skip values, e.g. to prevent mechanical resonance effects. See also [Maximum speed](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#maximum-speed) and [Skip frequency bands and minimum speed](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#skip-frequency-bands-and-minimum-speed).

#### Signal source

| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103122986123_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 speed setpoint](#g120-cu240-2-speed-setpoint) |
...
3. "Minimum speed" ([p1106](SINAMICS%20Parameter%20G120.md#p11060n-ci-minimum-speed-signal-source)); signal source for the minimum value of the speed setpoint.
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103122989451_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 ramp-function generator](#g120-cu240-2-ramp-function-generator) |
...
- [G120 CU240-2 ramp-function generator](#g120-cu240-2-ramp-function-generator)
- [G120 CU240-2 simple ramp-function generator](#g120-cu240-2-simple-ramp-function-generator)
- [G120 CU240-2 extended ramp-function generator](#g120-cu240-2-extended-ramp-function-generator)

#### G120 CU240-2 ramp-function generator
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103122946699_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 speed limitation](#g120-cu240-2-speed-limitation) |
...
1. To view the status of the internal enables, click "Internal enables".
...
1. In order to use the technology controller output as additional setpoint, select "Technology controller as additional speed setpoint" in the drop-down list ([p2251](SINAMICS%20Parameter%20G120.md#p2251-technology-controller-mode-2)).

   The technology controller output is then interconnected to the setpoint as additional setpoint in the "Ramp-function generator".
2. In order to use the technology controller output as main setpoint, select "Technology controller as main speed setpoint" in the drop-down list (p2251).

Both settings can also be made in the "Speed setpoint" screen form.

##### Signal processing

| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103123041803_DV_resource.Stream@PNG-en-US.png) | [Open-loop/closed-loop control type](#open-loopclosed-loop-control-type-1) |
...
[G120 CU240-2 speed controller](#g120-cu240-2-speed-controller)
  
[G120 CU240-2 V/f control](#g120-cu240-2-vf-control)

#### G120 CU240-2 simple ramp-function generator
...
#### G120 CU240-2 extended ramp-function generator
...
[Ramp-function generator](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#ramp-function-generator-1)
...
- [G120 CU240-2 motor](#g120-cu240-2-motor)
...
| Symbol | Meaning |
| --- | --- |
| ![Setting the open-loop/closed-loop control types](images/103123129739_DV_resource.Stream@PNG-en-US.png) | Control with V/f characteristic ([G120 CU240-2 V/f control](#g120-cu240-2-vf-control)) |
| ![Setting the open-loop/closed-loop control types](images/103123041803_DV_resource.Stream@PNG-en-US.png) | Field-oriented control (vector control - [G120 CU240-2 speed controller](#g120-cu240-2-speed-controller)) |
| [G120 CU240-2 torque control](#g120-cu240-2-torque-control) (part of the vector control) |  |
...
[G120 CU240-2 torque control](#g120-cu240-2-torque-control)
...
- [G120 CU240-2 speed controller](#g120-cu240-2-speed-controller)
- [SINAMICS G120 CU240-2 precontrol](#sinamics-g120-cu240-2-precontrol)
- [G120 CU240-2 droop feedback](#g120-cu240-2-droop-feedback)

##### G120 CU240-2 speed controller
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103122989451_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 ramp-function generator](#g120-cu240-2-ramp-function-generator) |
...
2. In the "Droop source" ([p1488](SINAMICS%20Parameter%20G120.md#p14880n-droop-input-source)) drop-down list, select which droop feedback you want to activate for the speed control.
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103123196043_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 torque setpoint](#g120-cu240-2-torque-setpoint) |
...
##### SINAMICS G120 CU240-2 precontrol
...
The droop function has a torque limiting effect on a drive that is mechanically coupled to a different speed (e.g. lead roller on a conveyor). In this way, a very effective load distribution can also be realized in connection with the torque setpoint of a leading speed-controlled drive. In contrast to torque control or load distribution with overriding and limitation, with the appropriate setting, such a load distribution controls even a smooth mechanical connection or slip.
...
| Symbol | Meaning |
| --- | --- |
| Droop of the torque setpoint | [G120 CU240-2 torque control](#g120-cu240-2-torque-control) |
| Droop of the speed controller output | [G120 CU240-2 speed controller](#g120-cu240-2-speed-controller) |
| Droop of the speed controller integral output |  |
...
- [G120 CU240-2 V/f control](#g120-cu240-2-vf-control)
- [G120 CU240-2 V/f control characteristics](#g120-cu240-2-vf-control-characteristics)
- [Settings of the G120 CU240-2 V/f characteristic](#settings-of-the-g120-cu240-2-vf-characteristic)
- [G120 CU240-2 V/f control I_max controller](#g120-cu240-2-vf-control-i_max-controller)
- [G120 CU240-2 slip compensation](#g120-cu240-2-slip-compensation)

##### G120 CU240-2 V/f control
...
See also [Properties of V/f control](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#properties-of-vf-control), [Selecting the V/f characteristic](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#selecting-the-vf-characteristic) and [Optimizing with a high break loose torque and brief overload](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#optimizing-with-a-high-break-loose-torque-and-brief-overload).

###### Signal sources

| Symbol | Meaning |
| --- | --- |
| ![Signal sources](images/103122989451_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 ramp-function generator](#g120-cu240-2-ramp-function-generator) |
| ![Signal sources](images/103123310219_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 Vdc controller](#g120-cu240-2-vdc-controller) |
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103123326347_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 current controller / power unit](#g120-cu240-2-current-controller-power-unit) |
...
##### G120 CU240-2 V/f control characteristics
...
##### Settings of the G120 CU240-2 V/f characteristic
...
1. To set a permanent voltage boost from standstill up to the rated speed, enter a value at "Voltage boost permanent" ([p1310](SINAMICS%20Parameter%20G120.md#p13100n-starting-current-voltage-boost-permanent-3)).
2. To set a speed-dependent voltage boost, enter a value at "Voltage boost at acceleration" ([p1311](SINAMICS%20Parameter%20G120.md#p13110n-starting-current-voltage-boost-when-accelerating-1)).
...
##### G120 CU240-2 V/f control I_max controller
...
##### G120 CU240-2 slip compensation
...
1. Activate or deactivate the slip compensation via the drop-down list box. Additional parameters are displayed when the slip compensation is activated.
...
- [G120 CU240-2 torque setpoint](#g120-cu240-2-torque-setpoint)
- [G120 CU240-2 torque limiting](#g120-cu240-2-torque-limiting)

#### G120 CU240-2 torque setpoint

##### Parameterizing the torque setpoints

Edit the torque setpoint through scaling or by injecting an additional setpoint. The supplementary torque acts for the torque control as well as for the speed control. This feature with the additional torque setpoint enables a precontrol torque to be implemented for speed control.

##### Signal source

| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103123041803_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 speed controller](#g120-cu240-2-speed-controller) |
...
| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103123523339_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 torque limiting](#g120-cu240-2-torque-limiting-1) |
...
[G120 CU240-2 torque limiting](#g120-cu240-2-torque-limiting-1)

#### G120 CU240-2 torque limiting
...
- [G120 CU240-2 torque limiting](#g120-cu240-2-torque-limiting-1)
- [G120 CU240-2 upper torque limit](#g120-cu240-2-upper-torque-limit)
- [G120 CU240-2 current limitation](#g120-cu240-2-current-limitation)
- [G120 CU240-2 power limit](#g120-cu240-2-power-limit)
- [G120 CU240-2 lower torque limit](#g120-cu240-2-lower-torque-limit)
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103123196043_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 upper torque limit](#g120-cu240-2-upper-torque-limit) |
...
#### G120 CU240-2 upper torque limit
...
#### G120 CU240-2 current limitation
...
#### G120 CU240-2 lower torque limit
...
- [G120 CU240-2 current controller / power unit](#g120-cu240-2-current-controller-power-unit)
- [G120 CU240-2 power unit / operating values](#g120-cu240-2-power-unit-operating-values)

#### G120 CU240-2 current controller / power unit
...
| Symbol | Meaning |
| --- | --- |
| ![Signal source](images/103123523339_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 torque limiting](#g120-cu240-2-torque-limiting-1) |
| ![Signal source](images/103123310219_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 Vdc controller](#g120-cu240-2-vdc-controller) |

##### Signal processing

| Symbol | Meaning |
| --- | --- |
| ![Signal processing](images/103123819531_DV_resource.Stream@PNG-en-US.png) | [G120 CU240-2 motor](#g120-cu240-2-motor) |
...
#### G120 CU240-2 power unit / operating values
...
- [G120 CU240-2 shutdown functions](#g120-cu240-2-shutdown-functions)
- [Brake control](#brake-control)
- [Safety Integrated](#safety-integrated)
- [Vdc controller](#vdc-controller)
- [G120 CU240-2 automatic restart](#g120-cu240-2-automatic-restart)
- [G120 CU240-2 flying restart](#g120-cu240-2-flying-restart)
- [Messages and monitors](#messages-and-monitors)

### G120 CU240-2 shutdown functions

#### Parameterizing the shutdown functions

Parameterize the shutdown functions of the G120 CU240 drive. See also [Shutdown functions OFF1, OFF2 and OFF3](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#shutdown-functions-off1-off2-and-off3).
...
- [CU240-2 brake control](#cu240-2-brake-control)
- [G120 CU240-2 motor holding brake](#g120-cu240-2-motor-holding-brake)
- [G120 CU240-2 DC brake](#g120-cu240-2-dc-brake)
- [G120 CU240-2 compound brake](#g120-cu240-2-compound-brake)

#### CU240-2 brake control

##### Selection of the brake type

The following brakes are available for the G120 CU240-2 converter:
...
#### G120 CU240-2 motor holding brake
...
4. Enter the monitoring time for the standstill detection at "Monitoring time" ([p1227](SINAMICS%20Parameter%20G120.md#p1227-zero-speed-detection-monitoring-time-1)). After reaching the speed threshold the monitoring time is started. After the monitoring time has elapsed, the "Open holding brake" signal is cancelled.
...
The extended functions provide additional safety functions such as SS1, SLS, SSM and SDI. See also [Safety functions](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safety-functions).
...
- [G120 control type / safety functions for extended functions](#g120-control-type-safety-functions-for-extended-functions)
- [G120 safe torque off (STO)](#g120-safe-torque-off-sto)
...
##### G120 CU240-2 function diagrams (FD)
...
1. Click the buttons to execute the corresponding tasks:
   ...
   - "[Control type / safety functions](#g120-control-type-safety-functions-for-extended-functions)" allows the control type (terminal/PROFIsafe) and the safety functions to be parameterized.
   - "[Test stop](#g120-safe-torque-off-sto)" allows the forced checking procedure (test stop) to be parameterized.
...
Information on how to assign the F-DIs can be found at [G120 F-DI assignment](#g120-f-di-assignment).
...
For a description of the STO function, see also [Safe Torque Off (STO)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safe-torque-off-sto), [Enabling SBC](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#enabling-sbc) and [Setting the delay time for SS1](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-the-delay-time-for-ss1).
...
[In Startdrive, how are the safe terminals assigned to a safety function?](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#in-startdrive-how-are-the-safe-terminals-assigned-to-a-safety-function)
...
##### G120 control type / safety functions for extended functions
...
Information on how to set the parameters for the control type can be found at [G120 F-DI/F-DO/PROFIsafe](#g120-f-dif-doprofisafe).
...
- Select "Enable" in the drop-down lists of the respective safety functions.
...
[Setting the forced checking procedure (test stop)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-the-forced-checking-procedure-test-stop-1)

##### G120 safe torque off (STO)

###### Description

You can assign the parameters for the "Safe Torque Off (STO)" function here. See also [Safe Torque Off (STO)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safe-torque-off-sto).
...
The safety function Safe Torque Off (STO) is for the safe separation of a motor from the power supply by the two-channel shutdown of the trigger pulses for the power transistors in the power unit. A stationary motor cannot start up with "STO active" (startup inhibit); a motor coasting down by the STO function cannot accelerate (exception: "pulling load").
...
- "STO active" ([r9773](SINAMICS%20Parameter%20G120.md#r9773031-cobo-si-status-processor-1-processor-2)); displays whether STO is active.
...
The "Safe Stop 1" (SS1) safety function brakes the motor safely with a subsequent transition to "Safe Torque Off" (STO) state. The specified setpoint for the motion control is ignored when SS1 is selected. You can enable and disable SS1 for the configuration of each drive axis of the drive controller. When SS1 is selected, the drive brakes actively on the OFF3 ramp and then changes to the pulse cancellation with possibly activation of SBC. See also [Safe Stop 1](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safe-stop-1).
...
[Setting SS1](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-ss1)

##### G120 safely-limited speed (SLS)

###### Description

The "Safely-Limited Speed" (SLS) function is used to protect a drive against unintentional high speed. This is achieved by monitoring the current drive speed in conjunction with a speed limit value. See also [Safely Limited Speed (SLS)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safely-limited-speed-sls).
...
[Setting SLS](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-sls)

##### G120 safe speed monitoring (SSM)

###### Description

You can parameterize the "Safe Speed Monitor" here. See also [Safe Speed Monitor (SSM)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safe-speed-monitor-ssm).
...
[Setting SSM](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-ssm)

##### G120 safe direction (SDI)

###### Description

With SDI (Safe Direction), you check the direction of the drive. Alternatively, either the positive or negative direction is checked. If the drive runs in the unsafe direction, the parameterized STOP response is triggered. See also [Safe Direction (SDI)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safe-direction-sdi).
...
[Setting SDI](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-sdi)
...
The acceptance test procedure is described in the SINAMICS G120 Safety Functions Function Manual. Further information can be found at [Recommended acceptance test](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#recommended-acceptance-test).
...
[Safe Torque Off (STO)](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#safe-torque-off-sto)
  
[Setting the filter for safe inputs](Commissioning%20SINAMICS%20G120-G115D-G110M%20drives.md#setting-the-filter-for-safe-inputs)
...
For further information, see also [G120 CU240-2 digital inputs](#g120-cu240-2-digital-inputs).
...
- [G120 CU240-2 Vdc controller](#g120-cu240-2-vdc-controller)
- [G120 CU240-2 Vdc controller switch-on level](#g120-cu240-2-vdc-controller-switch-on-level)

#### G120 CU240-2 Vdc controller
...
#### G120 CU240-2 Vdc controller switch-on level
...
1. Enter a value in [%] for the "Switch-in level" ([p1245](SINAMICS%20Parameter%20G120.md#p12450n-vdc_min-controller-switch-in-level-kinetic-buffering-4)) for the Vdc_min controller (kinetic buffering).
...
### G120 CU240-2 automatic restart
...
- [G120 CU240-2 load torque monitoring](#g120-cu240-2-load-torque-monitoring)
- [G120 CU240-2 motor temperature](#g120-cu240-2-motor-temperature)

#### G120 CU240-2 load torque monitoring
...
#### G120 CU240-2 motor temperature
...
- [G120 CU240-2 technology controller motorized potentiometer](#g120-cu240-2-technology-controller-motorized-potentiometer)
- [G120 CU240-2 MOP ramp-function generator of the technology controller](#g120-cu240-2-mop-ramp-function-generator-of-the-technology-controller)
- [G120 CU240-2 technology controller fixed setpoints](#g120-cu240-2-technology-controller-fixed-setpoints)
- [G120 CU240-2 technology controller PID control](#g120-cu240-2-technology-controller-pid-control)
- [G120 CU240-2 technology controller PID controller](#g120-cu240-2-technology-controller-pid-controller)
- [G120 CU240-2 technology controller ramp-up/ramp-down time](#g120-cu240-2-technology-controller-ramp-upramp-down-time)
- [G120 CU240-2 output limits of the technology controller](#g120-cu240-2-output-limits-of-the-technology-controller)
...
- [Motorized potentiometer](#g120-cu240-2-technology-controller-motorized-potentiometer)
- [Fixed setpoints](#g120-cu240-2-technology-controller-fixed-setpoints)
- [PID control](#g120-cu240-2-technology-controller-pid-control)
- [Ramp-up/down time](#g120-cu240-2-technology-controller-ramp-upramp-down-time)
- [Output limitation](#g120-cu240-2-output-limits-of-the-technology-controller)

#### G120 CU240-2 technology controller motorized potentiometer
...
#### G120 CU240-2 MOP ramp-function generator of the technology controller
...
#### G120 CU240-2 technology controller fixed setpoints
...
#### G120 CU240-2 technology controller PID control
...
#### G120 CU240-2 technology controller PID controller
...
#### G120 CU240-2 technology controller ramp-up/ramp-down time
...
#### G120 CU240-2 output limits of the technology controller
...
- [G120 CU240-2 PROFIdrive Receive Direction](#g120-cu240-2-profidrive-receive-direction)
- [G120 CU240-2 PROFIdrive Send Direction](#g120-cu240-2-profidrive-send-direction)
- [G120 CU240-2 PZD send/receive direction diagnostics](#g120-cu240-2-pzd-sendreceive-direction-diagnostics)

### G120 CU240-2 PROFIdrive Receive Direction
...
3. Click the ![Telegram selection](images/103125742347_DV_resource.Stream@PNG-en-US.png) button to display the control word / receive word bit-by-bit. For the free telegram configuration, the signals can be interconnected bit-by-bit here.
...
### G120 CU240-2 PROFIdrive Send Direction
...
### G120 CU240-2 PZD send/receive direction diagnostics
...
- [G120 CU240-2 interconnections](#g120-cu240-2-interconnections)

### G120 CU240-2 interconnections
