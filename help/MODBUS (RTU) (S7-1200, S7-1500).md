---
title: "MODBUS (RTU) (S7-1200, S7-1500)"
package: ProgFBCMMBenUS
topics: 11
...
- [Dependencies between library versions (S7-1200, S7-1500)](#dependencies-between-library-versions-s7-1200-s7-1500)
- [Overview of the Modbus RTU communication (S7-1200, S7-1500)](#overview-of-the-modbus-rtu-communication-s7-1200-s7-1500)
- [Modbus_Comm_Load: Configure communication module for Modbus (S7-1200, S7-1500)](#modbus_comm_load-configure-communication-module-for-modbus-s7-1200-s7-1500)
- [Modbus_Master: Communicate as Modbus master (S7-1200, S7-1500)](#modbus_master-communicate-as-modbus-master-s7-1200-s7-1500)
- [Modbus_Slave (S7-1200, S7-1500)](#modbus_slave-s7-1200-s7-1500)
- [Frame structure (S7-1200, S7-1500)](#frame-structure-s7-1200-s7-1500)
- [Error messages (S7-1200, S7-1500)](#error-messages-s7-1200-s7-1500)

## Dependencies between library versions (S7-1200, S7-1500)
...
## Overview of the Modbus RTU communication (S7-1200, S7-1500)
...
## Modbus_Comm_Load: Configure communication module for Modbus (S7-1200, S7-1500)
...
| ERROR | OUT | Bool |  | FALSE | The ERROR bit is TRUE for one cycle after the last request has been completed with errors. The error code in the STATUS parameter is only valid in the cycle in which ERROR = TRUE. |
| STATUS | OUT | Word |  | 0 | Error code (see [Error messages](#error-messages-s7-1200-s7-1500)) |
...
## Modbus_Slave (S7-1200, S7-1500)

This section contains information on the following topics:

- [Modbus_Slave: Communicate as Modbus slave (S7-1200, S7-1500)](#modbus_slave-communicate-as-modbus-slave-s7-1200-s7-1500)
- [Access to data areas in DBs instead of direct access to MODBUS addresses as of version V4.0 (S7-1200, S7-1500)](#access-to-data-areas-in-dbs-instead-of-direct-access-to-modbus-addresses-as-of-version-v40-s7-1200-s7-1500)
- [Restriction of read access to process images as of version V4.0 (S7-1200, S7-1500)](#restriction-of-read-access-to-process-images-as-of-version-v40-s7-1200-s7-1500)

### Modbus_Slave: Communicate as Modbus slave (S7-1200, S7-1500)
...
### Access to data areas in DBs instead of direct access to MODBUS addresses as of version V4.0 (S7-1200, S7-1500)
...
### Restriction of read access to process images as of version V4.0 (S7-1200, S7-1500)
...
## Frame structure (S7-1200, S7-1500)
...
| 16#8188 | Invalid operating mode or broadcast (MB_ADDR = 0) and MODE parameter ≠ 1 | Select the value 1 for MODE in Broadcast mode or select a different operating mode. |
| 16#8189 | Invalid data address | Select a suitable value for the data address at the DATA_ADDR parameter.  See description [Modbus_Master](#modbus_master-communicate-as-modbus-master-s7-1200-s7-1500) in the Info system |
| 16#818A | Invalid length | Select a suitable data length at the DATA_LEN parameter.  See description [Modbus_Master](#modbus_master-communicate-as-modbus-master-s7-1200-s7-1500) in the Info system |
| 16#818B | Invalid value for DATA_PTR | Select a suitable value for the data pointer at the DATA_PTR parameter (M or DB address).  See description [Modbus_Master](#modbus_master-communicate-as-modbus-master-s7-1200-s7-1500) in the Info system |
