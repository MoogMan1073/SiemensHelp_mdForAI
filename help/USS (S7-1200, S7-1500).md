---
title: "USS (S7-1200, S7-1500)"
package: ProgFBCMUSSenUS
topics: 10
...
- [Overview of USS communication (S7-1200, S7-1500)](#overview-of-uss-communication-s7-1200-s7-1500)
- [Requirements for using the USS protocol (S7-1200, S7-1500)](#requirements-for-using-the-uss-protocol-s7-1200-s7-1500)
- [USS_Port_Scan / USS_Port_Scan_31: Communication by means of a USS network (S7-1200, S7-1500)](#uss_port_scan-uss_port_scan_31-communication-by-means-of-a-uss-network-s7-1200-s7-1500)
- [USS_Drive_Control / USS_Drive_Control_31: Preparing and displaying data for the drive (S7-1200, S7-1500)](#uss_drive_control-uss_drive_control_31-preparing-and-displaying-data-for-the-drive-s7-1200-s7-1500)
- [USS_Read_Param / USS_Read_Param_31: Read data from drive (S7-1200, S7-1500)](#uss_read_param-uss_read_param_31-read-data-from-drive-s7-1200-s7-1500)
- [USS_Write_Param / USS_Write_Param_31: Change data in drive (S7-1200, S7-1500)](#uss_write_param-uss_write_param_31-change-data-in-drive-s7-1200-s7-1500)
- [General information on drive setup (S7-1200, S7-1500)](#general-information-on-drive-setup-s7-1200-s7-1500)
...
## Overview of USS communication (S7-1200, S7-1500)
...
## Requirements for using the USS protocol (S7-1200, S7-1500)
...
## USS_Port_Scan / USS_Port_Scan_31: Communication by means of a USS network (S7-1200, S7-1500)
...
Your program must execute the USS_Port_Scan / USS_Port_Scan_31 instruction often enough to prevent a timeout in the drive (see [Requirements for using the USS protocol](#requirements-for-using-the-uss-protocol-s7-1200-s7-1500) "Calculating time for communication with the drive").
...
## USS_Drive_Control / USS_Drive_Control_31: Preparing and displaying data for the drive  (S7-1200, S7-1500)
...
## USS_Read_Param / USS_Read_Param_31: Read data from drive (S7-1200, S7-1500)
...
| STATUS | OUT | UInt |  | 0 | Error code (see [Error messages](#error-messages-s7-1200-s7-1500)). |
...
## USS_Write_Param / USS_Write_Param_31: Change data in drive (S7-1200, S7-1500)
...
## General information on drive setup (S7-1200, S7-1500)
