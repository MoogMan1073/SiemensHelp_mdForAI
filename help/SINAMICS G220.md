...
- [Using a measuring function](#using-a-measuring-function)
...
The following table shows the maximum quantity structure for SINAMICS G220 that can be recorded with the trace and logic analyzer function:

| Device | Maximum number of installed traces | Maximum number of signals per trace |
| --- | --- | --- |
| **SINAMICS G220** | 2 | 8 1...4 signals; 0.25 ms minimum recording cycle 5...8 signals; 4.0 ms minimum recording cycle |
...
| - | ![Setting options and displays in "Signals"](images/140806041739_DV_resource.Stream@PNG-de-DE.png) | Button to open the signal selection table  The button is displayed when the table line is selected.  Clicking the icon opens a table which offers possible signals for selection. The selected signal is displayed in the input field. |
...
![Setting options and displays in "Recording conditions"](images/140806072715_DV_resource.Stream@PNG-en-US.png)
...
|  |  | ![Setting options and displays in "Recording conditions"](images/140806064651_DV_resource.Stream@PNG-de-DE.png) | Opens the signal selection table.  Clicking the icon opens a table which offers possible signals for selection as trigger tag. The selected signal is displayed in the input field. |
...
!["Bit pattern"](images/140806112395_DV_resource.Stream@PNG-en-US.png)
...
| Icon | Description |
| --- | --- |
| !["Bit pattern"](images/140806126731_DV_resource.Stream@PNG-de-DE.png) | Bit is not evaluated |
| !["Bit pattern"](images/140806134795_DV_resource.Stream@PNG-de-DE.png) | Bit is checked for FALSE |
| !["Bit pattern"](images/140806142859_DV_resource.Stream@PNG-de-DE.png) | Bit is checked for TRUE |
...
3. Select a signal. The following options are available:
   ...
   - In the "Name" column, click the ![Procedure](images/140806041739_DV_resource.Stream@PNG-de-DE.png) button and select a parameter.
...
2. Select a trigger parameter. The following options are available:
   ...
   - Click the !["Trigger on tag" trigger condition](images/140806041739_DV_resource.Stream@PNG-de-DE.png) button for the trigger parameter and select a parameter.
...
- The SINAMICS G220 drive has a firmware version from firmware V6.2.
...
- The SINAMICS G220 drive has a firmware version from V6.2.
- The "Startdrive Advanced" license is available.
...
- The SINAMICS G220 drive has a firmware version from SINAMICS FW V6.1.
