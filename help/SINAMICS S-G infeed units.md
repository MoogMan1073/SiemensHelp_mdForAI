...
> **Use of the infeeds**
>
> Not all of the listed infeeds can be used by all Control Units. An assignment can be found at "[Available components](Configuring%20SINAMICS%20S-G-MV%20drives.md#available-components)".
...
You can connect various function modules for the associated deployed infeed. The function modules that can be activated ([r0108](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#r0108-drive-objects-function-module-1)) are listed in the "Function modules" screen form.
...
| Braking Module External (r0108.26) | In the parameter view, activates parameter range [p3860](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p3860-number-of-braking-modules-connected-in-parallel)…[p3866](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p386607-bi-braking-module-fault) for the external Braking Modules. The corresponding parameters can only be parameterized in the parameter view. | X | X | X | ‑<sup>1)</sup> |
| **Other function modules** |  |  |  |  |  |
| Free function blocks (r0108.18) | In the parameter view, activates the parameters for the F blocks ([p20030](SINAMICS%20Parameter%20CU.md#p2003003-bi-and-0-inputs) … [p20288](SINAMICS%20Parameter%20CU.md#p20288-dif-0-run-sequence)). The free function blocks can only be parameterized in the parameter view. | X | X | X | ‑<sup>1)</sup> |
...
| Cosine Phi add-on module (r0108.10) | Precise cos(Phi) determination of fundamental current and voltage components with BICO-interconnectable input variables (in contrast to the power factor [r0038](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#r0038-power-factor-smoothed)). | X | X | ‑ | <sup>‑1)</sup> |
...
1. Enter a value for the device supply voltage in the "Device supply voltage" field ([p0210](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p0210-drive-unit-line-supply-voltage)).
...
1. Connect the signal source via "[p0840](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08400n-bi-on-off-off1)" for "OFF1 (low-active)".
2. Connect the 1st signal source via "[p0844](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08440n-bi-no-coast-down-coast-down-off2-signal-source-1)" for "Instantaneous OFF (OFF2) signal source 1".
3. Connect the 2nd signal source via "[p0845](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08450n-bi-no-coast-down-coast-down-off2-signal-source-2)" for "Instantaneous OFF (OFF2) signal source 2".
4. Connect the signal source via "[p0852](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08520n-bi-enable-operationinhibit-operation)" for "Enable operation".
...
- [p0810](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p0810-bi-command-data-set-selection-cds-bit-0)
- [p0811](SINAMICS%20Parameter%20VECTOR.md#p0811-bi-command-data-set-selection-cds-bit-1)
...
The bits of the missing enables ([r0046](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#r0046029-cobo-missing-enable-signal)) are displayed in the mask.
...
- Control word sequence control infeed ([r0898](SINAMICS%20Parameter%20CU.md#r0898015-cobo-control-word-drive-object-1))
- Status word sequence control infeed ([r0899](SINAMICS%20Parameter%20CU.md#r0899015-cobo-status-word-drive-object-1))
...
- Infeed status word ([r3405](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#r340507-cobo-infeed-status-word))
...
| --- | --- | --- | --- | --- |
| ON/OFF1 | STWAE.0 | [p0840](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08400n-bi-on-off-off1) ON/OFF2 | [r0898](SINAMICS%20Parameter%20CU.md#r0898015-cobo-control-word-drive-object-1).0 | A_STW1.0 |
| OFF2 | STWAE.1 | [p0844](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08440n-bi-no-coast-down-coast-down-off2-signal-source-1) 1 OFF2 and [p0845](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08450n-bi-no-coast-down-coast-down-off2-signal-source-2) 2 OFF2 | r0898.1 | A_STW1.1 |
| Operation enable | STWAE.3 | [p0852](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08520n-bi-enable-operationinhibit-operation) Enable operation | r0898.3 | A_STW1.3 |
| Disable motor operation | STWAE.5 | [p3532](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p3532-bi-infeed-inhibit-motoring) Disable motor operation | r0898.5 | A_STW1.5 |
| Inhibit regenerating | STWAE.6 | [p3533](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p3533-bi-infeed-inhibit-generator-mode) Disable regenerative operation | r0898.6 | A_STW1.6 |
| Acknowledge error | STWAE.7 | [p2103](SINAMICS%20Parameter%20CU.md#p2103-bi-1st-acknowledge-faults) 1 Acknowledge  or [p2104](SINAMICS%20Parameter%20CU.md#p2104-bi-2nd-acknowledge-faults) 2 Acknowledge  or [p2105](SINAMICS%20Parameter%20CU.md#p2105-bi-3rd-acknowledge-faults) 3 Acknowledge | [r2138](SINAMICS%20Parameter%20CU.md#r2138715-cobo-control-word-faultsalarms).7 | A_STW1.7 |
| Control by PLC | STWAE.10 | [p0854](SINAMICS%20Parameter%20ACTIVE%20INFEED%20CONTROL.md#p08540n-bi-control-by-plcno-control-by-plc) Control by PLC | r0898.10 | A_STW1.10 |

Active Infeed status message

| Signal name | Internal control word | Parameter | PROFIBUS telegram 370 |
| --- | --- | --- | --- |
| Ready for power-up | ZSWAE.0 | [r0899](SINAMICS%20Parameter%20CU.md#r0899015-cobo-status-word-drive-object-1).0 | A_ZSW1.0 |
| Ready to operate | ZSWAE.1 | r0899.1 | A_ZSW1.1 |
| Operation enabled | ZSWAE.2 | r0899.2 | A_ZSW1.2 |
| Fault active | ZSWAE.3 | [r2139](SINAMICS%20Parameter%20CU.md#r2139015-cobo-status-word-faultsalarms-1).3 | A_ZSW1.3 |
