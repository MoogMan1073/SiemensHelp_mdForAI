---
title: "System functions (RT Professional)"
package: FuncReferenceWCCPenUS
topics: 48
...
- [Other functions (RT Professional)](#other-functions-rt-professional)
- [User administration (RT Professional)](#user-administration-rt-professional)
- [Calculation (RT Professional)](#calculation-rt-professional)
- [Screens (RT Professional)](#screens-rt-professional)
- [Bit processing (RT Professional)](#bit-processing-rt-professional)
- [Settings (RT Professional)](#settings-rt-professional)
- [Keyboard (RT Professional)](#keyboard-rt-professional)
- [Keyboard operation for screen objects (RT Professional)](#keyboard-operation-for-screen-objects-rt-professional)

## Other functions (RT Professional)

This section contains information on the following topics:

- [SimulateSystemKey](#simulatesystemkey)
- [StopRuntime (RT Professional)](#stopruntime-rt-professional)
- [LookupText (RT Professional)](#lookuptext-rt-professional)

### SimulateSystemKey

#### Description

Simulates the behavior of a system key. Use this system function if a system key is not available on the HMI device. For example, the "ACK" key, the "Enter" key or the number block.

To make the system function usable, note the following steps:

- In the root screen: For the system key, disable the "Use local template" setting under "Properties > Properties > General".
- In created screens: For the system key, disable the "Use global assignment" setting under "Properties > Properties > General".
...
- [ExportImportUserAdministration (RT Professional)](#exportimportuseradministration-rt-professional)
- [ShowLogonDialog (RT Professional)](#showlogondialog-rt-professional)

### ExportImportUserAdministration (RT Professional)
...
### ShowLogonDialog (RT Professional)
...
## Calculation (RT Professional)

This section contains information on the following topics:

- [IncreaseTag (RT Professional)](#increasetag-rt-professional)
- [InvertLinearScaling (RT Professional)](#invertlinearscaling-rt-professional)
...
### InvertLinearScaling (RT Professional)
...
## Screens (RT Professional)

This section contains information on the following topics:

- [ActivateScreen (RT Professional)](#activatescreen-rt-professional)
- [ActivateScreenInCurrentScreenWindow (RT Professional)](#activatescreenincurrentscreenwindow-rt-professional)
...
- [SetPropertyCurrentWindowByProperty (RT Professional)](#setpropertycurrentwindowbyproperty-rt-professional)
- [SetPropertyCurrentWindow (RT Professional)](#setpropertycurrentwindow-rt-professional)
- [SetPropertyCurrentWindowByTagIndirect (RT Professional)](#setpropertycurrentwindowbytagindirect-rt-professional)
...
### ActivateScreenInCurrentScreenWindow (RT Professional)

#### Description

Performs a screen change to the specified screen in the current screen window.

#### Use in the function list

ActivateScreenInCurrentScreenWindow (New screen name)
...
### SetPropertyCurrentWindowByProperty (RT Professional)

#### Description

Specifies the value of an object property in the current window with another object property.

#### Use in the function list

SetPropertyCurrentWindowByProperty (Name of the property, Screen name, Screen object, Property name)
...
Name of the property whose property is to be transferred to the destination object.

**Screen name**

Name of the screen that contains the screen object.

**Screen object**

Name of the screen object to which the property is transferred.
...
### SetPropertyCurrentWindow (RT Professional)

#### Description

Specifies the value of an object property in the current window with a tag value.

#### Use in the function list

SetPropertyCurrentWindow (Name of the property, value)
...
### SetPropertyCurrentWindowByTagIndirect (RT Professional)

#### Description

Specifies the value of an object property in the current window with a tag. The tag contains the tag name that specifies the object property.

#### Use in the function list

SetPropertyCurrentWindowByTagIndirect (Name of target property, tag name)
...
## Bit processing (RT Professional)
...
## Settings (RT Professional)

This section contains information on the following topics:

- [GetPLCMode (RT Professional)](#getplcmode-rt-professional)
- [SetLanguage (RT Professional)](#setlanguage-rt-professional)

### GetPLCMode (RT Professional)
...
## Keyboard (RT Professional)

This section contains information on the following topics:

- [SetScreenKeyboardMode (RT Professional)](#setscreenkeyboardmode-rt-professional)

### SetScreenKeyboardMode (RT Professional)
...
## Keyboard operation for screen objects (RT Professional)

This section contains information on the following topics:

- [ShowBlockInTiaPortalFromAlarm (RT Professional)](#showblockintiaportalfromalarm-rt-professional)
- [ShowPLCCodeViewFromAlarm (RT Professional)](#showplccodeviewfromalarm-rt-professional)

### ShowBlockInTiaPortalFromAlarm (RT Professional)
...
[Configuring a jump from the alarm (RT Professional)](Using%20the%20diagnostics%20functions%20%28Basic%20Panels%2C%20Panels%2C%20Comfort%20Panels%2C%20RT%20Advanced%2C%20RT%20Professional%29.md#configuring-a-jump-from-the-alarm-rt-professional)

### ShowPLCCodeViewFromAlarm (RT Professional)
