---
title: "FBD (S7-1200, S7-1500)"
package: ProgFUP2MenUS
topics: 197
...
- [AND truth table (S7-1200, S7-1500)](#and-truth-table-s7-1200-s7-1500)
- [&gt;=1: OR logic operation (S7-1200, S7-1500)](#1-or-logic-operation-s7-1200-s7-1500)
- [OR truth table (S7-1200, S7-1500)](#or-truth-table-s7-1200-s7-1500)
- [X: EXCLUSIVE OR logic operation (S7-1200, S7-1500)](#x-exclusive-or-logic-operation-s7-1200-s7-1500)
- [EXCLUSIVE OR truth table (S7-1200, S7-1500)](#exclusive-or-truth-table-s7-1200-s7-1500)
- [Insert input (S7-1200, S7-1500)](#insert-input-s7-1200-s7-1500)
- [Invert RLO (S7-1200, S7-1500)](#invert-rlo-s7-1200-s7-1500)
...
| --- | --- | --- | --- | --- | --- |
| S7-1200 | S7-1500 |  |  |  |  |
| &lt;Operand&gt; | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | The operand indicates the bit whose signal state will be queried. |
...
[Adding additional inputs and outputs to FBD elements (S7-1200, S7-1500)](Creating%20FBD%20programs.md#adding-additional-inputs-and-outputs-to-fbd-elements-s7-1200-s7-1500)
...
[Example of detecting the direction of a conveyor belt](Creating%20FBD%20programs.md#example-of-detecting-the-direction-of-a-conveyor-belt)
  
[Example of controlling room temperature](Creating%20FBD%20programs.md#example-of-controlling-room-temperature)
  
[Example of detecting the fill level of a storage area](Creating%20FBD%20programs.md#example-of-detecting-the-fill-level-of-a-storage-area)
...
> Under the following conditions:
>
> - The instruction "OR logic operation" is interconnected at its inputs with multiple comparator operations (e.g. CMP ==) with the data type String, WString or Variant.
> - The result ("TRUE") for the instruction "OR logic operation" is already fulfilled by the comparator operation of the same type (data type String, WString or Variant) with the signal state "TRUE".
>
> Result: In online mode, the following comparator operations (data type String, WString or Variant) of the interconnection is shown as "inactive".
>
> **Example**:
>
> Operand 1: CMP == (data type String) returns the signal state "FALSE". CMP == is shown as "active".
>
> Operand 2: CMP == (data type String) returns the signal state "TRUE". CMP == is shown as "active".
>
> Operand 3: CMP == (data type String) returns the signal state "TRUE". CMP == is shown as "inactive".
>
> Operand 4: CMP == (data type INT) returns the signal state "TRUE". CMP == is shown as "active".
>
> Result of the "OR logic operation": Signal state "TRUE".
...
[Example of controlling a conveyor belt](Creating%20FBD%20programs.md#example-of-controlling-a-conveyor-belt)
...
![Example](images/71442635147_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71443663883_DV_resource.Stream@PNG-de-DE.png)
...
| --- | --- | --- | --- | --- | --- |
| S7-1200 | S7-1500 |  |  |  |  |
| EN | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
...
![Example](images/30538051851_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/30540321931_DV_resource.Stream@PNG-de-DE.png)
...
| --- | --- | --- | --- | --- | --- |
| S7-1200 | S7-1500 |  |  |  |  |
| S | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable setting |
...
| --- | --- | --- | --- | --- | --- |
| S7-1200 | S7-1500 |  |  |  |  |
| R | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable resetting |
...
![Example](images/71529782539_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71530952075_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71531481611_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71531838731_DV_resource.Stream@PNG-de-DE.png)
...
- [TONR: Time accumulator (S7-1200, S7-1500)](#tonr-time-accumulator-s7-1200-s7-1500-1)
...
| IN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T,C, P or constant | Start input |
...
| ET | Output | TIME | TIME, LTIME | I, Q, M, D, L | I, Q, M, D, L, P | Current timer value |
...
![Example](images/84621285131_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/84621490443_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/84621631755_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/84621875467_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/41690807051_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/41690811019_DV_resource.Stream@PNG-de-DE.png)
...
- IN input
  ...
  The "Start on-delay timer" instruction compares the current RLO with the RLO from the previous query, which is saved in the "IN" parameter in the instance data. If the instruction detects a change in the RLO from "0" to "1", there is a positive signal edge and the time measurement is started. After the "Start on-delay timer" instruction has been processed, the value of the IN parameter is updated in the instance data and is used as edge memory bit for the next query.
...
- Q and ET outputs
  ...
  The internal parameters of the "Start on-delay timer" instruction are used to calculate the time values for Q and ET. Note that the time measurement is disrupted when the actual values of the instruction are written or initialized by other functions.
...
![Example](images/41692217995_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/41692221963_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/41692285835_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/21534665099_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/41692682251_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/19391446539_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/15945270539_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/41692784267_DV_resource.Stream@PNG-de-DE.png)
...
| S | Input | BOOL | I, Q, M, T, C, D, L, P or constant | Start input |
...
![Example](images/121309578635_DV_resource.Stream@PNG-en-US.png)

"#Timer_1" starts when the signal state of the "#TagIn_1" operand changes from "0" to "1". The timer expires with the time value of the "#TagIn_Number" operand as long as the signal state of the "#TagIn_1" operand is "1". If the signal state at the "#TagIn_1" operand changes from "1" to "0" before the timer expires, the timer is stopped.

Network 2:

![Example](images/103439131403_DV_resource.Stream@PNG-de-DE.png)

As long as the timer is running, the "#TagOut" operand returns signal state "1".

Network 3:

![Example](images/103439272459_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/121368051979_DV_resource.Stream@PNG-en-US.png)
...
![Example](images/103445628683_DV_resource.Stream@PNG-de-DE.png)

As long as the timer is running, the "#TagOut" operand returns signal state "1".

Network 3:

![Example](images/103445731339_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/103794498571_DV_resource.Stream@PNG-en-US.png)
...
![Example](images/103456940043_DV_resource.Stream@PNG-de-DE.png)

When the time expires, the "#TagOut" operand is reset to "1".

Network 3:

![Example](images/103456965899_DV_resource.Stream@PNG-de-DE.png)
...
The duration is made up internally of a time value and a time base and is programmed at parameter TV. When the instruction is started, the programmed time value is counted down towards zero. The time base indicates the time period with which the time value is changed.
...
![Example](images/121369026443_DV_resource.Stream@PNG-en-US.png)
...
![Example](images/103457728523_DV_resource.Stream@PNG-de-DE.png)

As long as the timer is running, the "#TagOut" operand is set to "1".

Network 3:

![Example](images/103457779979_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/20189786507_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/30493681163_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/30493445259_DV_resource.Stream@PNG-de-DE.png)
...
| CU | Input | BOOL | I, Q, M, D, L, T, C or constant | Count up input |
...
- [OK: Check validity (S7-1200, S7-1500)](#ok-check-validity-s7-1200-s7-1500)
- [NOT_OK: Check invalidity (S7-1200, S7-1500)](#not_ok-check-invalidity-s7-1200-s7-1500)
...
| IN2 | Input | Bit strings, integers, floating-point numbers, character strings, timers, date and time, ARRAY of &lt;data type&gt; with fixed and variable ARRAY limits, STRUCT, VARIANT, ANY, PLC data type | I, Q, M, D, L, P or constant | Second value to compare |
...
![Example](images/59235938827_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/20192145675_DV_resource.Stream@PNG-de-DE.png)
...
| IN2 | Input | Bit strings, integers, floating-point numbers, character strings, timers, date and time | I, Q, M, D, L, P, or constant | Second value to compare |
...
![Example](images/20192454923_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/20194010763_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/20194818443_DV_resource.Stream@PNG-de-DE.png)
...
### OK: Check validity (S7-1200, S7-1500)
...
![Example](images/20199606923_DV_resource.Stream@PNG-de-DE.png)
...
### NOT_OK: Check invalidity (S7-1200, S7-1500)
...
![Example](images/20199710603_DV_resource.Stream@PNG-de-DE.png)
...
You can use the "Compare data type for EQUAL with the data type of a tag" instruction to query the data type of a tag to which a VARIANT points. You are comparing the data type of the tag at IN1 parameter, which you declared in the block interface, with the data type of a tag at IN2 parameter for "Equal".
...
| IN2 | Input | Bit sequences, integers, floating-point numbers, timers, date and time, character strings, ARRAY, PLC data types | I, Q, M, D, L | I, Q, M, D, L, P | Second operand |
| OUT | Output | BOOL | I, Q, M, D, L | I, Q, M, D, L | Result of comparison |

##### Example

The following example shows how the instruction works:

![Example](images/99634881035_DV_resource.Stream@PNG-de-DE.png)

The "TagOut" output is set when the following conditions are fulfilled:

- The operand "TagIn" has the signal state "1".
- The condition of the comparison instruction is fulfilled, i.e. the #Tag1 operand is equal to "Tag2".
...
![Example](images/99636502155_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/99636929931_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/99637383307_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71540908427_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71548665611_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71549159051_DV_resource.Stream@PNG-de-DE.png)
...
| IN2 | Input | TYPE_ID | I, Q, M, D, L | I, Q, M, D, L, P | Second operand |
| OUT | Output | BOOL | I, Q, M, D, L | I, Q, M, D, L | Result of comparison |
...
![Example](images/99633723915_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/99635475339_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71550528139_DV_resource.Stream@PNG-de-DE.png)
...
[Example of calculating an equation](Creating%20FBD%20programs.md#example-of-calculating-an-equation)
...
| --- | --- | --- | --- | --- | --- | --- |
| S7-1200 | S7-1500 | S7-1200 | S7-1500 |  |  |  |
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
...
![Example](images/71597196427_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71599164427_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71599592331_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| IN1 | Input | Integers, floating-point numbers, DTL, DT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | First input value |
| IN2 | Input | Integers, floating-point numbers, DTL, DT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Second input value |
| INn | Input | Integers, floating-point numbers, DTL, DT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Additionally inserted inputs whose values are to be compared |
| OUT | Output | Integers, floating-point numbers, DTL, DT | I, Q, M, D, L, P | I, Q, M, D, L, P | Result |
...
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| MN | Input | Integers, floating-point numbers, TIME, TOD, DATE, DTL, DT | Integers, floating-point numbers, TIME, LTIME, TOD, LTOD, DATE, LDT, DTL, DT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Low limit |
| IN | Input | Integers, floating-point numbers, TIME, TOD, DATE, DTL, DT | Integers, floating-point numbers, TIME, LTIME, TOD, LTOD, DATE, LDT, DTL, DT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Input value |
| MX | Input | Integers, floating-point numbers, TIME, TOD, DATE, DTL, DT | Integers, floating-point numbers, TIME, LTIME, TOD, LTOD, DATE, LDT, DTL, DT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | High limit |
| OUT | Output | Integers, floating-point numbers, TIME, TOD, DATE, DTL, DT | Integers, floating-point numbers, TIME, LTIME, TOD, LTOD, DATE, LDT, DTL, DT | I, Q, M, D, L, P | I, Q, M, D, L, P | Result |
...
![Example](images/71714576779_DV_resource.Stream@PNG-de-DE.png)
...
You can use the "Exponentiate" instruction to raise the value at the input IN1 by a power specified with the value at input IN2. The result of the instruction is stored at output OUT and can be queried there (OUT = IN1<sup>IN2</sup>).
...
![Example](images/71714991883_DV_resource.Stream@PNG-de-DE.png)
...
If the "TagIn" operand returns signal state TRUE, the instruction is executed. The instruction moves the contents of the "TagIn_Value" operand to the "TagOut_Value" operand. If the instruction is executed without errors, the ENO and "TagOut" enable outputs are set to signal state TRUE.
...
[Removing instruction inputs and outputs (S7-1200, S7-1500)](Creating%20FBD%20programs.md#removing-instruction-inputs-and-outputs-s7-1200-s7-1500)
...
![Example](images/59393038731_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/59398146443_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | I, Q, M, D, L or constant | Enable input |
| ENO | Output | BOOL | I, Q, M, D, L | Enable output |
| SRC_VARIABLE | Input | all data types | D, block interface of an FB, no I/O data | Tag to be serialized.   S7-1500:  For optimum performance, do not provide the parameter with a VARIANT pointer. |
| DEST_ARRAY | InOut | ARRAY of BYTE or ARRAY of CHAR | D, block interface of an FB (the sections Input, Output, Static and Temp are possible.)  No I/O data | ARRAY in which the generated data stream is stored.  S7-1500:  For optimum performance, do not provide the parameter with a VARIANT pointer. |
...
![Example](images/59389249163_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/59392641419_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/59392833675_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| IN<sup> 1)</sup> | Input | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD, LTOD | D, L | D, L | The first element of the source area that is being copied |
| COUNT | Input | USINT, UINT, UDINT | USINT, UINT, UDINT, ULINT | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Number of elements to be copied from the source range to the target range |
| OUT<sup> 1)</sup> | Output | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD, LTOD | D, L | D, L | The first element of the target range to which the contents of the source range are being copied |
...
![Example](images/71718888715_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71719260555_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71719847179_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| IN | Input | Binary numbers, integers, floating-point numbers, timers, DATE, TOD, CHAR, WCHAR | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD, LTOD | I, Q, M, D, L, P, or constant | I, Q, M, D, L, P, or constant | Element used to fill the target range |
...
| OUT | Output | Binary numbers, integers, floating-point numbers, timers, DATE, TOD, CHAR, WCHAR | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD, LTOD | D, L | D, L | Address in target range from which filling starts |
...
![Example with an ARRAY](images/82085876747_DV_resource.Stream@PNG-de-DE.png)
...
![Examples with a structure](images/81957701771_DV_resource.Stream@PNG-de-DE.png)

Generate the following program code to address the MyStruct2 tag:

![Examples with a structure](images/81958879627_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| IN | Input | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD, LTOD | I, Q, M, D, L, P, or constant | I, Q, M, D, L, P, or constant | Element used to fill the target range |
| COUNT | Input | USINT, UINT, UDINT | USINT, UINT, UDINT, ULINT | I, Q, M, D, L, P, or constant | I, Q, M, D, L, P, or constant | Number of repeated move operations |
| OUT | Output | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD | Binary numbers, integers, floating-point numbers, timers, DATE, CHAR, WCHAR, TOD, LTOD | D, L | D, L | Address in target range from which filling starts |
...
![Example with an ARRAY](images/82087958155_DV_resource.Stream@PNG-de-DE.png)
...
![Examples with a structure](images/81978362635_DV_resource.Stream@PNG-de-DE.png)

Generate the following program code to address the MyStruct2 tag:

![Examples with a structure](images/81981626891_DV_resource.Stream@PNG-de-DE.png)
...
![Example with an ARRAY](images/95499485835_DV_resource.Stream@PNG-de-DE.png)
...
![Example with a PLC data type (UDT)](images/99147437963_DV_resource.Stream@PNG-de-DE.png)
...
![Example of a destination ARRAY with the low limit "0"](images/95510352907_DV_resource.Stream@PNG-de-DE.png)
...
![Example of a destination ARRAY with the low limit "-2"](images/95630706571_DV_resource.Stream@PNG-de-DE.png)
...
![Example with an ARRAY](images/95499792779_DV_resource.Stream@PNG-de-DE.png)
...
![Example with a PLC data type (UDT)](images/99189065483_DV_resource.Stream@PNG-de-DE.png)
...
![Example of a source ARRAY with the low limit "0"](images/95646637707_DV_resource.Stream@PNG-de-DE.png)
...
![Example of a source ARRAY with the low limit "-2"](images/95650618763_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/156607043979_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/156607048203_DV_resource.Stream@PNG-de-DE.png)
...
![Description](images/14315942539_DV_resource.Stream@PNG-en-US.png)
...
![Example](images/71721562763_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/88110267915_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/88121199499_DV_resource.Stream@PNG-de-DE.png)
...
| 8753 | The size of the parameter does not match the element length in the ARRAY data block. |
| * The error codes can be displayed as integer or hexadecimal values in the program editor. You can find information on switching the display formats under "See also". |  |
...
![Example](images/88124603147_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/88126869003_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/59777277707_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/59778971531_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/59780173963_DV_resource.Stream@PNG-de-DE.png)
...
![Example of step 1](images/151336730763_DV_resource.Stream@PNG-de-DE.png)
...
![Example of step 2](images/166852661131_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/147754561035_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/166849413515_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/166849417739_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/82105373707_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/82105513227_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71721929355_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71722399243_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71750336011_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71751830667_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71752001803_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71752599179_DV_resource.Stream@PNG-de-DE.png)

The following example shows the conversion of a byte (8 bit) to the unsigned integer USINT (8 bit):

![Example](images/71752692619_DV_resource.Stream@PNG-de-DE.png)
...
[Explicit conversions (S7-1200)](Data%20types.md#explicit-conversions-s7-1200)
...
![Description](images/14358549003_DV_resource.Stream@PNG-en-US.png)
...
![Example](images/71764308619_DV_resource.Stream@PNG-de-DE.png)
...
![Description](images/14352340875_DV_resource.Stream@PNG-en-US.png)
...
| EN | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| MIN<sup> 1)</sup> | Input | Integers, floating-point numbers | I, Q, M, D, L or constant | I, Q, M, D, L or constant | Low limit of the value range |
| VALUE<sup> 1)</sup> | Input | Integers, floating-point numbers | I, Q, M, D, L or constant | I, Q, M, D, L or constant | Value to be normalized. |
| MAX<sup> 1)</sup> | Input | Integers, floating-point numbers | I, Q, M, D, L or constant | I, Q, M, D, L or constant | High limit of the value range |
...
![Example](images/71764697611_DV_resource.Stream@PNG-de-DE.png)
...
| HI_LIM | Input | REAL | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | High limit |
| LO_LIM | Input | REAL | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Low limit |
| BIPOLAR | Input | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L or constant | Indicates whether the value at the IN parameter is to be interpreted as bipolar or unipolar. The parameter can assume the following values:  1: Bipolar  0: Unipolar |
...
| Parameters | Declaration | Data type | Memory area | Description |
| --- | --- | --- | --- | --- |
| EN | Input | BOOL | I, Q, M, L, D or constant | Enable input |
| K | Input | UINT | I, Q, M, L, D or constant | Specifies the number of the output and thus the jump that is to be made. |
...
![Example](images/21676396171_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/21677251211_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/20218188043_DV_resource.Stream@PNG-de-DE.png)
...
- [PC systems (S7-1200, S7-1500)](PC%20systems%20%28ProgFUPShtDWN15enUS%29.md#pc-systems)
...
![Example](images/71787393547_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71787622027_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71787983243_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/40319476235_DV_resource.Stream@PNG-de-DE.png)

Network 2:

![Example](images/40322804107_DV_resource.Stream@PNG-de-DE.png)

Network 3:

![Example](images/40322816779_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/71805226379_DV_resource.Stream@PNG-de-DE.png)

The following figure shows how the instruction works using concrete operand values:

![Example](images/20222015627_DV_resource.Stream@PNG-de-DE.png)
...
![Example](images/20222024075_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| K | Input | Integers | Integers | I, Q, M, D, L, P or constant | I, Q, M, D, L, P or constant | Specifies the input whose content is to be copied.  - If K = 0 =&gt; Parameter IN0 - If K = 1 =&gt; Parameter IN1, etc. |
...
![Example](images/71807109771_DV_resource.Stream@PNG-de-DE.png)
...
| EN | Input | BOOL | BOOL | I, Q, M, D, L or constant | I, Q, M, D, L, T, C or constant | Enable input |
| ENO | Output | BOOL | BOOL | I, Q, M, D, L | I, Q, M, D, L | Enable output |
| K | Input | Integers | Integers | I, Q, M, D, L, P, or constant | I, Q, M, D, L, P, or constant | Specifies the output to which the input value (IN) is copied.  - If K = 0 =&gt; Parameter OUT0 - If K = 1 =&gt; Parameter OUT1, etc. |
...
![Example](images/71807456651_DV_resource.Stream@PNG-de-DE.png)
...
![Description](images/51495613963_DV_resource.Stream@PNG-en-US.png)
...
![Description](images/51497707787_DV_resource.Stream@PNG-en-US.png)
...
![Description](images/51500774411_DV_resource.Stream@PNG-en-US.png)
...
![Description](images/51501716747_DV_resource.Stream@PNG-en-US.png)
...
![Example](images/68035281803_DV_resource.Stream@PNG-de-DE.png)
