---
title: "SINAMICS Parameter TB30 (Terminal Board)"
package: sdrMVpa100enUS
topics: 476
source: Siemens TIA Portal Information System (offline help, en-US)
---


# SINAMICS Parameter TB30 (Terminal Board)
...
## SINAMICS Parameter TB30 (Terminal Board) 00002 - 04023

SINAMICS Parameter TB30 (Terminal Board) 00002 - 04023

### r0002 TB30 operating display

|  |  |  |
| --- | --- | --- |
| **Can be changed:**- | **Calculated:**- | **Access level:**1 |
| **Data type:**Integer16 | **Dynamic index:**- | **Func. diagram:** - |
| **Object:**TB30 | **P-Group:**- | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| 0 | 250 | [ ] - |
| [Alarms](SINAMICS%20Alarms%20TB30%20%28Terminal%20Board%29.md#sinamics-alarms-tb30-terminal-board) |  |  |
...
### p0010 TB30 commissioning parameter filter

|  |  |  |
| --- | --- | --- |
| **Can be changed:** C2( 1) T | **Calculated:**- | **Access level:**1 |
| **Data type:**Integer16 | **Dynamic index:**- | **Func. diagram:** - |
| **Object:**TB30 | **P-Group:**All groups | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| 0 | 30 | [ 0 ] 0 |
...
| **Can be changed:**- | **Calculated:**- | **Access level:**2 |
| **Data type:**Integer16 | **Dynamic index:**- | **Func. diagram:** - |
| **Object:**TB30 | **P-Group:**Closed-loop control | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| 100 | 100 | [ ] - |
...
### p0161 Option board component number

|  |  |  |
| --- | --- | --- |
| **Can be changed:** C1( 4) C2( 15) | **Calculated:**- | **Access level:**4 |
| **Data type:**Unsigned8 | **Dynamic index:**- | **Func. diagram:** - |
| **Object:**TB30 | **P-Group:**Data sets | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| 0 | 199 | [ 0 ] 0 |
...
Only component numbers can be entered into this parameter that correspond to an option
board.
...
### p0970 TB30 reset parameters

|  |  |  |
| --- | --- | --- |
| **Can be changed:** C2( 30) | **Calculated:**- | **Access level:**2 |
| **Data type:**Unsigned16 | **Dynamic index:**- | **Func. diagram:** - |
| **Object:**TB30 | **P-Group:**Factory settings | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| 0 | 100 | [ 0 ] 0 |
...
clock cycle.  
Parameter p0161 is not reset. It is only reset if the entire drive unit is reset to
...
### r4021 TB30 digital inputs terminal actual value

|  |  |  |
| --- | --- | --- |
| **Can be changed:**- | **Calculated:**- | **Access level:**2 |
| **Data type:**Unsigned32 | **Dynamic index:**- | **Func. diagram:** 9100 |
| **Object:**TB30 | **P-Group:**Commands | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| - | - | [ ] - |
...
from the simulation mode (p4095.x = 1) to the terminal mode (p4095.x = 0).
...
### r4022.0...3 CO/BO: TB30 digital inputs status

|  |  |  |
| --- | --- | --- |
| **Can be changed:**- | **Calculated:**- | **Access level:**1 |
| **Data type:**Unsigned32 | **Dynamic index:**- | **Func. diagram:** 9099, 9100 |
| **Object:**TB30 | **P-Group:**Commands | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
...
### r4023.0...3 BO: TB30 digital inputs status inverted
...
## SINAMICS Parameter TB30 (Terminal Board) 04030 - 20039

SINAMICS Parameter TB30 (Terminal Board) 04030 - 20039

### p4030 BI: TB30 signal source for terminal DO 0

|  |  |  |
| --- | --- | --- |
| **Can be changed:**UT | **Calculated:**- | **Access level:**1 |
| **Data type:**Unsigned32 / Binary | **Dynamic index:**- | **Func. diagram:** 9099, 9102 |
| **Object:**TB30 | **P-Group:**Commands | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
...
### p4031 BI: TB30 signal source for terminal DO 1
...
### p4032 BI: TB30 signal source for terminal DO 2
...
### p4033 BI: TB30 signal source for terminal DO 3
...
### r4047 TB30 digital outputs status
...
### p4048 TB30 invert digital outputs
...
| --- | --- | --- | --- | --- |
| Bit | Signal name | 0 signal | 1 signal | Function diagram |
| 00 | DO 0 (X481.5) | Not inverted | Inverted | - |
| 01 | DO 1 (X481.6) | Not inverted | Inverted | - |
| 02 | DO 2 (X481.7) | Not inverted | Inverted | - |
| 03 | DO 3 (X481.8) | Not inverted | Inverted | - |

**Note:**
  
DO: Digital Output

### r4052[0...1] CO: TB30 analog inputs actual input voltage

|  |  |  |
| --- | --- | --- |
| **Can be changed:**- | **Calculated:**- | **Access level:**1 |
| **Data type:**FloatingPoint32 | **Dynamic index:**- | **Func. diagram:** 9104 |
| **Object:**TB30 | **P-Group:**Terminals | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| - [V] | - [V] | [ ] - [V] |
...
Displays the actual input voltage at the analog inputs for Terminal Board 30 (TB30).  
Note:  
For p4056[x] = 3 (unipolar current input monitored (+4 mA ... +20 mA)) the following
applies:  
...
### p4053[0...1] TB30 analog inputs smoothing time constant
...
### r4055[0...1] CO: TB30 analog inputs actual value in percent

|  |  |  |
| --- | --- | --- |
| **Can be changed:**- | **Calculated:**- | **Access level:**1 |
| **Data type:**FloatingPoint32 | **Dynamic index:**- | **Func. diagram:** 9099, 9104 |
| **Object:**TB30 | **P-Group:**Terminals | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
...
Displays the currently referred input value of the analog inputs of Terminal Board
30 (TB30).  
...
### r4056[0...1] TB30 analog inputs type
...
### p4057[0...1] TB30 analog inputs characteristic value x1
...
Sets the scaling characteristic for the analog inputs of Terminal Board 30 (TB30).  
...
### p4058[0...1] TB30 analog inputs characteristic value y1
...
### p4059[0...1] TB30 analog inputs characteristic value x2
...
### p4060[0...1] TB30 analog inputs characteristic value y2
...
### p4063[0...1] TB30 analog inputs offset
...
### p4066[0...1] TB30 analog inputs activate absolute value generation
...
Activates the absolute value generation for the analog input signals of the Terminal
Board 30 (TB30).
...
### p4067[0...1] BI: TB30 analog inputs invert signal source
...
Sets the signal source to invert the analog input signals of the Terminal Board 30
(TB30).
...
### p4068[0...1] TB30 analog inputs noise suppression window
...
Sets the noise suppression window of the analog inputs for Terminal Board 30 (TB30).  
...
### p4069[0...1] BI: TB30 analog inputs signal source for enable
...
### p4071[0...1] CI: TB30 analog outputs signal source

|  |  |  |
| --- | --- | --- |
| **Can be changed:**UT | **Calculated:**- | **Access level:**1 |
| **Data type:**Unsigned32 / FloatingPoint32 | **Dynamic index:**- | **Func. diagram:** 9099, 9106 |
| **Object:**TB30 | **P-Group:**Terminals | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**PERCENT | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
...
### r4072[0...1] TB30 analog outputs output value currently referred
...
Displays the actual referred output value of the analog outputs of the Terminal Board
30 (TB30).
...
### p4073[0...1] TB30 analog outputs smoothing time constant
...
### r4074[0...1] TB30 analog outputs actual output voltage
...
Displays the actual output voltage at the analog outputs of the Terminal Board 30
(TB30).
...
### p4075[0...1] TB30 analog outputs activate absolute value generation
...
Activates the absolute value generation for the analog outputs of the Terminal Board
30 (TB30).
...
### r4076[0...1] TB30 analog outputs type
...
### p4077[0...1] TB30 analog outputs characteristic value x1
...
Sets the scaling characteristic for the analog outputs of Terminal Board 30 (TB30).  
...
### p4078[0...1] TB30 analog outputs characteristic value y1
...
Sets the scaling characteristic for the analog outputs of Terminal Board 30 (TB30).  
The scaling characteristic for the analog outputs is defined using 2 points.  
This parameter specifies the y coordinate (output voltage in V) of the 1st value pair
of the characteristic.
...
### p4079[0...1] TB30 analog outputs characteristic value x2
...
### p4080[0...1] TB30 analog outputs characteristic value y2
...
Sets the scaling characteristic for the analog outputs of Terminal Board 30 (TB30).  
The scaling characteristic for the analog outputs is defined using 2 points.  
This parameter specifies the y coordinate (output voltage in V) of the 2nd value pair
of the characteristic.
...
### p4082[0...1] BI: TB30 analog outputs invert signal source
...
Sets the signal source for inverting the analog output signals of the Terminal Board
30 (TB30).
...
### p4083[0...1] TB30 analog outputs offset
...
Sets the offset for the analog outputs of Terminal Board 30 (TB30).  
...
### p4095 TB30 digital inputs simulation mode
...
A drive that is moved by simulating the inputs of a Terminal Board is brought to a
standstill while the Terminal Module is being activated or deactivated.
...
### p4096 TB30 digital inputs simulation mode setpoint
...
### p4097[0...1] TB30 analog inputs simulation mode
...
### p4098[0...1] TB30 analog inputs simulation mode setpoint
...
Sets the setpoint for the input voltage in the simulation mode of the analog inputs
of Terminal Board 30 (TB30).
...
### p4099[0...2] TB30 inputs/outputs sampling time

|  |  |  |
| --- | --- | --- |
| **Can be changed:** C1( 3) | **Calculated:**- | **Access level:**3 |
| **Data type:**FloatingPoint32 | **Dynamic index:**- | **Func. diagram:** 9099, 9100 |
| **Object:**TB30 | **P-Group:**Commands | **Version:**5230300 |
| **Units group:**- | **Unit selection:**- |  |
| **Not for motor type:**- | **Scaling:**- | **Expert list:**1 |
| **Min** | **Max** | **Factory setting** |
| 0.00 [µs] | 5000.00 [µs] | [ 0 ] 4000.00 [µs]  [ 1 ] 4000.00 [µs]  [ 2 ] 4000.00 [µs] |
| [Alarms](SINAMICS%20Alarms%20TB30%20%28Terminal%20Board%29.md#sinamics-alarms-tb30-terminal-board) |  |  |
...
Sets the sampling time for the inputs and outputs of Terminal Board 30 (TB30).
...
The sampling times can only be set as an integer multiple of the lowest basic sampling
time (r0110[0]).  
...
-> 0).  
For clock cycle synchronous PROFIBUS operation, the TB30 hardware (e.g. analog/digital
converter) is operated with the PROFIBUS clock cycle (r2064[1]). This clock cycle
is also kept after the PROFIBUS connection has been exited up to the next time that
the Control Unit is switched off. In this case, a faster sampling time than the PROFIBUS
...
## SINAMICS Parameter TB30 (Terminal Board) 20040 - 20140
...
## SINAMICS Parameter TB30 (Terminal Board) 20141 - 20241
...
## SINAMICS Parameter TB30 (Terminal Board) 20242 - 21046
